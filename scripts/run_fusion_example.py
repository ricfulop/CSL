...
def main() -> None:
    example_csl_ir = {
        ...
        "export": [
            {"id": "stl_out", "format": "STL", "path": "out/plate.stl", "target": "part"}
        ],
        "thumbnail": [
            {"id": "preview", "path": "out/preview.png", "width": 800, "height": 600, "view": "iso", "style": "shaded"}
        ]
    }
    ...
    Path("out/mapping.json").write_text(json.dumps(mapping, indent=2))
    print("Done. Mapping written to out/mapping.json")
