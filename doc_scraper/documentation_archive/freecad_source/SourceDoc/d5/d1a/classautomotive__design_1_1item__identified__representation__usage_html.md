---
url: https://freecad.github.io/SourceDoc/d5/d1a/classautomotive__design_1_1item__identified__representation__usage.html
scraped_at: 2025-09-08T15:06:48.443122
title: Untitled
---
  ...
  * [item_identified_representation_usage](../../d5/d1a/classautomotive__design_1_1item__identified__representation__usage.html)

[List of all members](../../d0/dc4/classautomotive__design_1_1item__identified__representation__usage-members.html) | Public Member Functions | Public Attributes

automotive_design.item_identified_representation_usage Class Reference
...
def automotive_design.item_identified_representation_usage.definition  | ( | | ) |   
---|---|---|---|---  
...
def automotive_design.item_identified_representation_usage.description  | ( | | ) |   
---|---|---|---|---  
...
def automotive_design.item_identified_representation_usage.identified_item  | ( | | ) |   
---|---|---|---|---  
...
automotive_design.item_identified_representation_usage._identified_item, and
automotive_design.id_attribute._identified_item.

## ◆ name()

def automotive_design.item_identified_representation_usage.name  | ( | | ) |   
---|---|---|---|---  
...
def automotive_design.item_identified_representation_usage.used_representation  | ( | | ) |   
---|---|---|---|---  
...
def automotive_design.item_identified_representation_usage.wr1  | ( |  | _self_| ) |   
---|---|---|---|---|---  
  
Reimplemented in
[automotive_design.draughting_model_item_association](../../da/d5e/classautomotive__design_1_1draughting__model__item__association.html#a0405f8d48a083aa8b24bbb891c3e7deb).

References App::TransactionFactory.self, Py::PythonExtension< T >.self(),
Py::PythonClass< T >.self(), Py::PythonExtensionBase.self(),
Gui::AutoSaver.self, Gui::Dialog::DownloadManager.self, and
...
automotive_design.item_identified_representation_usage.definition  
---  
  
## ◆ description

automotive_design.item_identified_representation_usage.description  
---  
...
automotive_design.item_identified_representation_usage.identified_item  
---  
  
## ◆ name

automotive_design.item_identified_representation_usage.name  
---  
...
automotive_design.item_identified_representation_usage.used_representation  
---  
