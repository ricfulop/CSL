...
scraped_at: 2025-09-08T14:22:49.538588
title: CompositorNodeDoubleEdgeMask(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeDoubleEdgeMask(_CompositorNode_)¶
...
enum in [`BLEED_OUT`, `KEEP_IN`], default `BLEED_OUT`
...
enum in [`ALL`, `ADJACENT_ONLY`], default `ALL`
