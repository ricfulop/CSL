...
scraped_at: 2025-09-08T14:23:27.699339
title: CompositorNodePremulKey(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodePremulKey(_CompositorNode_)¶
...
Conversion between premultiplied alpha and key alpha
  ...
  * `STRAIGHT_TO_PREMUL` To Premultiplied – Convert straight to premultiplied.

  * `PREMUL_TO_STRAIGHT` To Straight – Convert premultiplied to straight.

Type:

    

enum in [`STRAIGHT_TO_PREMUL`, `PREMUL_TO_STRAIGHT`], default
`STRAIGHT_TO_PREMUL`
