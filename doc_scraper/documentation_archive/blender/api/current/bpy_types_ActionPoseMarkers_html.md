...
scraped_at: 2025-09-08T14:19:21.726235
title: ActionPoseMarkers(bpy_struct)¶
---
...
**name** (_string_ _,__(__never None_ _)_) – New name for the marker (not
unique)
...
**marker**
([`TimelineMarker`](bpy.types.TimelineMarker.html#bpy.types.TimelineMarker
"bpy.types.TimelineMarker"), (never None)) – Timeline marker to remove
...
## References¶
  ...
  * [`Action.pose_markers`](bpy.types.Action.html#bpy.types.Action.pose_markers "bpy.types.Action.pose_markers")
