...
scraped_at: 2025-09-08T14:24:16.867725
title: CurveModifier(Modifier)¶
---
...
_class _bpy.types.CurveModifier(_Modifier_)¶
...
enum in [`POS_X`, `POS_Y`, `POS_Z`, `NEG_X`, `NEG_Y`, `NEG_Z`], default
`POS_X`
