...
scraped_at: 2025-09-08T14:24:41.027843
title: DriverVariable(bpy_struct)¶
---
...
_class _bpy.types.DriverVariable(_bpy_struct_)¶
...
[`DriverTarget`](bpy.types.DriverTarget.html#bpy.types.DriverTarget
"bpy.types.DriverTarget"), (readonly)
...
enum in [`SINGLE_PROP`, `TRANSFORMS`, `ROTATION_DIFF`, `LOC_DIFF`,
`CONTEXT_PROP`], default `SINGLE_PROP`
...
## References¶
  ...
  * [`ChannelDriverVariables.new`](bpy.types.ChannelDriverVariables.html#bpy.types.ChannelDriverVariables.new "bpy.types.ChannelDriverVariables.new")
  * [`ChannelDriverVariables.remove`](bpy.types.ChannelDriverVariables.html#bpy.types.ChannelDriverVariables.remove "bpy.types.ChannelDriverVariables.remove")

|

  * [`Driver.variables`](bpy.types.Driver.html#bpy.types.Driver.variables "bpy.types.Driver.variables")
