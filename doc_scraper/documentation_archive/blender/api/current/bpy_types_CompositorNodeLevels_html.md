...
scraped_at: 2025-09-08T14:23:09.620700
title: CompositorNodeLevels(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeLevels(_CompositorNode_)¶
...
channel¶
  ...
  * `COMBINED_RGB` Combined – Combined RGB.
...
enum in [`COMBINED_RGB`, `RED`, `GREEN`, `BLUE`, `LUMINANCE`], default
`COMBINED_RGB`
