...
scraped_at: 2025-09-08T14:23:33.749852
title: CompositorNodeScale(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeScale(_CompositorNode_)¶
...
Offset image horizontally (factor of image size). (Deprecated: Use a Translate
node instead.)
...
Offset image vertically (factor of image size). (Deprecated: Use Translate
node instead.)
...
enum in [`RELATIVE`, `ABSOLUTE`, `SCENE_SIZE`, `RENDER_SIZE`], default
`RELATIVE`
