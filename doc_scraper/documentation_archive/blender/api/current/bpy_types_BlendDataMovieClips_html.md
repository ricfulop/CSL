...
scraped_at: 2025-09-08T14:20:28.978376
title: BlendDataMovieClips(bpy_struct)¶
---
...
remove(_clip_ , _*_ , _do_unlink =True_, _do_id_user =True_, _do_ui_user
=True_)¶
...
Parameters:
  ...
  * **clip** ([`MovieClip`](bpy.types.MovieClip.html#bpy.types.MovieClip "bpy.types.MovieClip"), (never None)) – Movie clip to remove

  * **do_unlink** (_boolean_ _,__(__optional_ _)_) – Unlink all usages of this movie clip before deleting it

  * **do_id_user** (_boolean_ _,__(__optional_ _)_) – Decrement user counter of all datablocks used by this movie clip
...
Add a new movie clip to the main database from a file (while `check_existing`
is disabled for consistency with other load functions, behavior with multiple
movie-clips using the same file may incorrectly generate proxies)
