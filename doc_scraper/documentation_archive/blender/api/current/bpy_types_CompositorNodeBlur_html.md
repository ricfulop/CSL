...
scraped_at: 2025-09-08T14:22:15.412010
title: CompositorNodeBlur(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeBlur(_CompositorNode_)¶
...
enum in [`FLAT`, `TENT`, `QUAD`, `CUBIC`, `GAUSS`, `FAST_GAUSS`, `CATROM`,
`MITCH`], default `FLAT`
...
Extend bounds of the input image to fully fit blurred image. (Deprecated: Use
Extend Bounds input instead.)
...
Apply filter on gamma corrected values. (Deprecated: Unused. Use Gamma node
instead.)
