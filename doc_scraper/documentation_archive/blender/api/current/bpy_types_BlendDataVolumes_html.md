...
scraped_at: 2025-09-08T14:20:43.038575
title: BlendDataVolumes(bpy_struct)¶
---
...
remove(_volume_ , _*_ , _do_unlink =True_, _do_id_user =True_, _do_ui_user
=True_)¶
...
Parameters:
  ...
  * **volume** ([`Volume`](bpy.types.Volume.html#bpy.types.Volume "bpy.types.Volume"), (never None)) – Volume to remove
  ...
  * **do_id_user** (_boolean_ _,__(__optional_ _)_) – Decrement user counter of all datablocks used by this volume data
