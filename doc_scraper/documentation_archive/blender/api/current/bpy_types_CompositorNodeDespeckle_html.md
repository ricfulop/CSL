...
scraped_at: 2025-09-08T14:22:44.510731
title: CompositorNodeDespeckle(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeDespeckle(_CompositorNode_)¶
...
Threshold for detecting pixels to despeckle. (Deprecated: Use Color Threshold
input instead.)
...
Threshold for the number of neighbor pixels that must match. (Deprecated: Use
Neighbor Threshold instead.)
