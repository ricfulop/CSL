...
scraped_at: 2025-09-08T14:22:42.511553
title: CompositorNodeDefocus(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeDefocus(_CompositorNode_)¶
...
enum in [`OCTAGON`, `HEPTAGON`, `HEXAGON`, `PENTAGON`, `SQUARE`, `TRIANGLE`,
...
Enable gamma correction before and after main process. (Deprecated: Unused.
Use Gamma node instead.)
...
Disable when using an image as input instead of actual z-buffer (auto enabled
if node not image based, eg. time node)
