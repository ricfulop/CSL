...
scraped_at: 2025-09-08T14:22:25.477481
title: CompositorNodeColorSpill(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeColorSpill(_CompositorNode_)¶
...
enum in [`SIMPLE`, `AVERAGE`], default `SIMPLE`
...
Compensate all channels (differently) by hand. (Deprecated: Use “Use Spill
