...
scraped_at: 2025-09-08T14:22:22.831098
title: CompositorNodeColorBalance(CompositorNode)¶
---
...
enum in [`LIFT_GAMMA_GAIN`, `OFFSET_POWER_SLOPE`, `WHITEPOINT`], default
`LIFT_GAMMA_GAIN`
...
(Deprecated: Use Input Tint input instead.)
...
Support negative color by using this as the RGB basis. (Deprecated: Use Offset
Basis input instead.)
...
Color temperature of the output’s white point. (Deprecated: Use Output
Temperature input instead.)
...
(Deprecated: Use Output Tint input instead.)
