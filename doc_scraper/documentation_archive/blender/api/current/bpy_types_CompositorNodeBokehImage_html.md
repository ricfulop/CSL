...
scraped_at: 2025-09-08T14:22:17.407732
title: CompositorNodeBokehImage(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeBokehImage(_CompositorNode_)¶
...
float in [-12.5664, 12.5664], default 0.0

catadioptric¶

    

Level of catadioptric of the bokeh. (Deprecated: Use Catadioptric Size input
instead)
