...
scraped_at: 2025-09-08T14:22:24.443384
title: CompositorNodeColorMatte(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeColorMatte(_CompositorNode_)¶
...
Hue tolerance for colors to be considered a keying color. (Deprecated: Use Hue
input instead.)
...
Saturation tolerance for the color. (Deprecated: Use Saturation input
instead.)
