...
scraped_at: 2025-09-08T14:23:41.794742
title: CompositorNodeSetAlpha(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeSetAlpha(_CompositorNode_)¶
...
mode¶
  ...
  * `APPLY` Apply Mask – Multiply the input image’s RGBA channels by the alpha input value.

  * `REPLACE_ALPHA` Replace Alpha – Replace the input image’s alpha channel by the alpha input value.

Type:

    

enum in [`APPLY`, `REPLACE_ALPHA`], default `APPLY`
