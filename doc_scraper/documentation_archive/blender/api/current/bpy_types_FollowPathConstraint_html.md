...
scraped_at: 2025-09-08T14:25:38.341007
title: FollowPathConstraint(Constraint)¶
---
...
enum in [`FORWARD_X`, `FORWARD_Y`, `FORWARD_Z`, `TRACK_NEGATIVE_X`,
`TRACK_NEGATIVE_Y`, `TRACK_NEGATIVE_Z`], default `FORWARD_X`
