...
scraped_at: 2025-09-08T14:20:41.045150
title: BlendDataTexts(bpy_struct)¶
---
...
_class _bpy.types.BlendDataTexts(_bpy_struct_)¶
...
remove(_text_ , _*_ , _do_unlink =True_, _do_id_user =True_, _do_ui_user
=True_)¶
...
Parameters:
  ...
  * **text** ([`Text`](bpy.types.Text.html#bpy.types.Text "bpy.types.Text"), (never None)) – Text to remove

  * **do_unlink** (_boolean_ _,__(__optional_ _)_) – Unlink all usages of this text before deleting it

  * **do_id_user** (_boolean_ _,__(__optional_ _)_) – Decrement user counter of all datablocks used by this text

  * **do_ui_user** (_boolean_ _,__(__optional_ _)_) – Make sure interface does not reference this text

load(_filepath_ , _*_ , _internal =False_)¶
