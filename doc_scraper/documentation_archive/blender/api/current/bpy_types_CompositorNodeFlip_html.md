...
scraped_at: 2025-09-08T14:22:53.597297
title: CompositorNodeFlip(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeFlip(_CompositorNode_)¶
...
(Deprecated: Use Flip X and Flip Y inputs instead.)

Type:

    

enum in [`X`, `Y`, `XY`], default `X`
