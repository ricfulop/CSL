...
scraped_at: 2025-09-08T14:22:21.498908
title: CompositorNodeChromaMatte(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeChromaMatte(_CompositorNode_)¶
...
Tolerance below which colors will be considered as exact matches. (Deprecated:
Use Minimum input instead.)

Type:

    

float in [0, 0.523599], default 0.0

tolerance¶

    

Tolerance for a color to be considered a keying color. (Deprecated: Use
Maximum input instead.)

Type:

    

float in [0.0174533, 1.39626], default 0.0
