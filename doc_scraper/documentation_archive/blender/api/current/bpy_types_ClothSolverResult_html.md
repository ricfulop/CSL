...
scraped_at: 2025-09-08T14:21:48.296310
title: ClothSolverResult(bpy_struct)¶
---
...
_class _bpy.types.ClothSolverResult(_bpy_struct_)¶
...
enum set in {`SUCCESS`, `NUMERICAL_ISSUE`, `NO_CONVERGENCE`, `INVALID_INPUT`},
default `{'SUCCESS'}`, (readonly)
...
## References¶
  ...
  * [`ClothModifier.solver_result`](bpy.types.ClothModifier.html#bpy.types.ClothModifier.solver_result "bpy.types.ClothModifier.solver_result")
