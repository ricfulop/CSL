...
scraped_at: 2025-09-08T14:22:50.550649
title: CompositorNodeEllipseMask(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeEllipseMask(_CompositorNode_)¶
...
X position of the middle of the ellipse. (Deprecated: Use Position input
instead.)
...
Y position of the middle of the ellipse. (Deprecated: Use Position input
instead.)
