---
url: https://docs.blender.org/api/current/bpy.types.CompositorNodeComposite.html
scraped_at: 2025-09-08T14:22:32.470060
title: CompositorNodeComposite(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeComposite(_CompositorNode_)¶
...
Colors are treated alpha premultiplied, or colors output straight (alpha gets
set to 1). (Deprecated: Unused.)
