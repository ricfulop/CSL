...
scraped_at: 2025-09-08T14:22:55.587971
title: CompositorNodeGlare(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeGlare(_CompositorNode_)¶
...
spectral dispersion effect. (Deprecated: Use Color Modulation input instead)
...
enum in [`BLOOM`, `GHOSTS`, `STREAKS`, `FOG_GLOW`, `SIMPLE_STAR`], default
`SIMPLE_STAR`
...
(Deprecated: Use Iterations input instead)
...
(Deprecated: Use Strength input instead)
...
pixels). (Deprecated: Use Size input instead)

Type:

    

int in [1, 9], default 0
...
Simple star filter: add 45 degree rotation offset. (Deprecated: Use Diagonal
input instead)
