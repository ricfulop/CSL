...
scraped_at: 2025-09-08T14:22:13.445518
title: CompositorNodeAntiAliasing(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeAntiAliasing(_CompositorNode_)¶
...
current one). (Deprecated: Use Contrast Limit input instead.)
...
How much sharp corners will be rounded. (Deprecated: Use Corner Rounding input
instead.)
