...
scraped_at: 2025-09-08T14:22:46.528284
title: CompositorNodeDilateErode(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeDilateErode(_CompositorNode_)¶
...
Distance to grow/shrink (number of iterations). (Deprecated: Use Size input
instead.)
...
enum in [`STEP`, `THRESHOLD`, `DISTANCE`, `FEATHER`], default `STEP`
