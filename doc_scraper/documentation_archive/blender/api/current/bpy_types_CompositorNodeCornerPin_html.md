...
scraped_at: 2025-09-08T14:22:34.486257
title: CompositorNodeCornerPin(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeCornerPin(_CompositorNode_)¶
...
enum in [`NEAREST`, `BILINEAR`, `BICUBIC`, `ANISOTROPIC`], default
`ANISOTROPIC`
