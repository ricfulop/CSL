...
scraped_at: 2025-09-08T14:19:34.778430
title: AnimDataDrivers(bpy_struct)¶
---
...
**src_driver** ([`FCurve`](bpy.types.FCurve.html#bpy.types.FCurve
"bpy.types.FCurve"), (optional)) – Existing Driver F-Curve to use as template
for a new one
...
Find a driver F-Curve. Note that this function performs a linear scan of all
driver F-Curves.
