...
scraped_at: 2025-09-08T14:23:07.635065
title: CompositorNodeKuwahara(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeKuwahara(_CompositorNode_)¶
...
omnidirectional while 2 means it is maximally directed along the edges of the
image. (Deprecated: Use Eccentricity input instead.)
...
completely sharp. (Deprecated: Use Sharpness input instead.)
...
Controls the uniformity of the direction of the filter. Higher values produces
more uniform directions. (Deprecated: Use Uniformity input instead.)
...
Uses a more precise but slower method. Use if the output contains undesirable
noise. (Deprecated: Use High Precision input instead.)
