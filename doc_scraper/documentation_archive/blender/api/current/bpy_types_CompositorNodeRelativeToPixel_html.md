...
scraped_at: 2025-09-08T14:23:31.765151
title: CompositorNodeRelativeToPixel(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeRelativeToPixel(_CompositorNode_)¶
...
enum in [`PER_DIMENSION`, `X`, `Y`, `Greater`, `Smaller`, `Diagonal`], default
`X`
