...
scraped_at: 2025-09-08T14:23:14.626676
title: CompositorNodeMask(CompositorNode)¶
---
...
_class _bpy.types.CompositorNodeMask(_CompositorNode_)¶
...
Number of motion blur samples. (Deprecated: Use Motion Blur Samples input
instead.)
...
Exposure for motion blur as a factor of FPS. (Deprecated: Use Motion Blur
Shutter input instead.)
...
enum in [`SCENE`, `FIXED`, `FIXED_SCENE`], default `SCENE`
...
Use feather information from the mask. (Deprecated: Use Feather input
instead.)
...
Use multi-sampled motion blur of the mask. (Deprecated: Use Motion Blur input
instead.)
