...
scraped_at: 2025-09-08T14:20:31.066391
title: BlendDataObjects(bpy_struct)¶
---
...
Parameters:
  ...
  * **object_data** ([`ID`](bpy.types.ID.html#bpy.types.ID "bpy.types.ID")) – Object data or None for an empty object
...
remove(_object_ , _*_ , _do_unlink =True_, _do_id_user =True_, _do_ui_user
=True_)¶
...
Parameters:
  ...
  * **object** ([`Object`](bpy.types.Object.html#bpy.types.Object "bpy.types.Object"), (never None)) – Object to remove

  * **do_unlink** (_boolean_ _,__(__optional_ _)_) – Unlink all usages of this object before deleting it

  * **do_id_user** (_boolean_ _,__(__optional_ _)_) – Decrement user counter of all datablocks used by this object
...
## References¶
  ...
  * [`BlendData.objects`](bpy.types.BlendData.html#bpy.types.BlendData.objects "bpy.types.BlendData.objects")
