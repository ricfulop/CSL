---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_GH_ParamWireDisplay.htm
scraped_at: 2025-09-08T16:17:23.567683
title: Untitled
---
...
---|---|---|---  
| default| 0|  Wire display is controlled by the application settings.  
| faint| 1|  Wires are displayed faintly (thin and transparent) while the
parameter is not selected.  
| hidden| 2|  Wires are not displayed at all while the parameter is not
selected.  
