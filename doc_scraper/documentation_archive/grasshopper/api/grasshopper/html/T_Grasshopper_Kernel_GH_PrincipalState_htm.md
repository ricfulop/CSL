---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_GH_PrincipalState.htm
scraped_at: 2025-09-08T16:17:41.649625
title: Untitled
---
...
Enumerates the different possible states in which the masterness of a
parameter can occur.
...
---|---|---|---  
| CannotBePrincipal| 0|  This parameter cannot be a principal parameter. It is
not a valid component input.  
| IsPrincipal| 1|  This parameter is the current principal parameter as
defined by the component which owns it.  
| IsNotPrincipal| 2|  This parameter is not the current principal parameter,
but it could be.  
