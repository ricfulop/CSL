---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_GH_PersistentReferenceParam_1.htm
scraped_at: 2025-09-08T16:17:28.633107
title: Untitled
---
...
[GH_PersistentReferenceParam(T) Constructor
](../html/M_Grasshopper_Kernel_GH_PersistentReferenceParam_1__ctor.htm
"GH_PersistentReferenceParam\(T\) Constructor ")

[GH_PersistentReferenceParam(T)
Properties](../html/Properties_T_Grasshopper_Kernel_GH_PersistentReferenceParam_1.htm
"GH_PersistentReferenceParam\(T\) Properties")

[GH_PersistentReferenceParam(T)
Methods](../html/Methods_T_Grasshopper_Kernel_GH_PersistentReferenceParam_1.htm
"GH_PersistentReferenceParam\(T\) Methods")

[GH_PersistentReferenceParam(T)
Events](../html/Events_T_Grasshopper_Kernel_GH_PersistentReferenceParam_1.htm
"GH_PersistentReferenceParam\(T\) Events")

[GH_PersistentReferenceParam(T)
Fields](../html/Fields_T_Grasshopper_Kernel_GH_PersistentReferenceParam_1.htm
"GH_PersistentReferenceParam\(T\) Fields")

![Click or drag to resize](../icons/TocOpen.gif)![Click or drag to
resize](../icons/TocClose.gif)

# GH_PersistentReferenceParamT Class  
...
Grasshopper.KernelGH_PersistentReferenceParamT  
[Grasshopper.Rhinoceros.ParamsModelContentParamT](T_Grasshopper_Rhinoceros_Params_ModelContentParam_1.htm)  
...
Copy
    ...
    public abstract class GH_PersistentReferenceParam<T> : GH_PersistentParam<T>
    where T : class, IGH_ReferencedData
    
    
    
    Public MustInherit Class GH_PersistentReferenceParam(Of T As {Class, IGH_ReferencedData})
...
The GH_PersistentReferenceParamT type exposes the following members.
...
[GH_PersistentReferenceParamT](M_Grasshopper_Kernel_GH_PersistentReferenceParam_1__ctor.htm)|
Initializes a new instance of the GH_PersistentReferenceParamT class  
Top
