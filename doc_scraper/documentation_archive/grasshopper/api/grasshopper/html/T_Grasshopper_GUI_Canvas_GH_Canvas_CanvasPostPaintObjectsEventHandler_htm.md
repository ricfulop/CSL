---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_GUI_Canvas_GH_Canvas_CanvasPostPaintObjectsEventHandler.htm
scraped_at: 2025-09-08T16:14:04.693411
title: Untitled
---
...
# GH_CanvasCanvasPostPaintObjectsEventHandler Delegate  
...
Copy
    ...
    public delegate void CanvasPostPaintObjectsEventHandler(
    	GH_Canvas sender
    )
    
    
    Public Delegate Sub CanvasPostPaintObjectsEventHandler ( 
    	sender As GH_Canvas
    )
