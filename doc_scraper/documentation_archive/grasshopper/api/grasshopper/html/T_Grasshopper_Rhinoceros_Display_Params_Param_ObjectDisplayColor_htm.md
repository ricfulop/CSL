---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Rhinoceros_Display_Params_Param_ObjectDisplayColor.htm
scraped_at: 2025-09-08T16:23:43.231308
title: Untitled
---
...
[Param_ObjectDisplayColor Constructor
](../html/M_Grasshopper_Rhinoceros_Display_Params_Param_ObjectDisplayColor__ctor.htm
"Param_ObjectDisplayColor Constructor ")

[Param_ObjectDisplayColor
Properties](../html/Properties_T_Grasshopper_Rhinoceros_Display_Params_Param_ObjectDisplayColor.htm
"Param_ObjectDisplayColor Properties")

[Param_ObjectDisplayColor
Methods](../html/Methods_T_Grasshopper_Rhinoceros_Display_Params_Param_ObjectDisplayColor.htm
"Param_ObjectDisplayColor Methods")

[Param_ObjectDisplayColor
Events](../html/Events_T_Grasshopper_Rhinoceros_Display_Params_Param_ObjectDisplayColor.htm
"Param_ObjectDisplayColor Events")
...
[Grasshopper.KernelGH_Param](T_Grasshopper_Kernel_GH_Param_1.htm)[ObjectDisplayColor](T_Grasshopper_Rhinoceros_Display_ObjectDisplayColor.htm)  
[Grasshopper.KernelGH_PersistentParam](T_Grasshopper_Kernel_GH_PersistentParam_1.htm)[ObjectDisplayColor](T_Grasshopper_Rhinoceros_Display_ObjectDisplayColor.htm)  
Grasshopper.Rhinoceros.Display.ParamsParam_ObjectDisplayColor  
...
Copy
    ...
    public sealed class Param_ObjectDisplayColor : GH_PersistentParam<ObjectDisplayColor>
    
    
    Public NotInheritable Class Param_ObjectDisplayColor
    	Inherits GH_PersistentParam(Of ObjectDisplayColor)

The Param_ObjectDisplayColor type exposes the following members.
...
[Param_ObjectDisplayColor](M_Grasshopper_Rhinoceros_Display_Params_Param_ObjectDisplayColor__ctor.htm)|
Initializes a new instance of the Param_ObjectDisplayColor class  
Top
...
![Public property](../icons/pubproperty.gif)|
[ComponentGuid](P_Grasshopper_Rhinoceros_Display_Params_Param_ObjectDisplayColor_ComponentGuid.htm)|
(Overrides
...
[GH_InstanceDescription](T_Grasshopper_Kernel_GH_InstanceDescription.htm).)  
![Public property](../icons/pubproperty.gif)|
[Exposure](P_Grasshopper_Rhinoceros_Display_Params_Param_ObjectDisplayColor_Exposure.htm)|
(Overrides
