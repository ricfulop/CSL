---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_GH_Document_SolutionStartEventHandler.htm
scraped_at: 2025-09-08T16:16:23.312758
title: Untitled
---
...
# GH_DocumentSolutionStartEventHandler Delegate  
...
Copy
    ...
    public delegate void SolutionStartEventHandler(
    	Object sender,
    	GH_SolutionEventArgs e
    )
    
    
    Public Delegate Sub SolutionStartEventHandler ( 
    	sender As Object,
...
e
    ...
    Type: [Grasshopper.KernelGH_SolutionEventArgs](T_Grasshopper_Kernel_GH_SolutionEventArgs.htm)  
