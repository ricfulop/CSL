---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_GUI_Canvas_GH_Canvas_CanvasPostPaintWiresEventHandler.htm
scraped_at: 2025-09-08T16:14:07.710391
title: Untitled
---
...
# GH_CanvasCanvasPostPaintWiresEventHandler Delegate  
...
Copy
    ...
    public delegate void CanvasPostPaintWiresEventHandler(
    	GH_Canvas sender
    )
    
    
    Public Delegate Sub CanvasPostPaintWiresEventHandler ( 
    	sender As GH_Canvas
    )
