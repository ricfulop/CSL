---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_GH_DocumentObject_ColourEventHandler.htm
scraped_at: 2025-09-08T16:16:30.317466
title: Untitled
---
...
# GH_DocumentObjectColourEventHandler Delegate  
...
Copy
    ...
    public delegate void ColourEventHandler(
    	GH_ColourPicker sender,
    	GH_ColourPickerEventArgs e
    )
    
    
    Public Delegate Sub ColourEventHandler ( 
    	sender As GH_ColourPicker,
    	e As GH_ColourPickerEventArgs
    )
...
sender
    ...
    Type: [Grasshopper.GUIGH_ColourPicker](T_Grasshopper_GUI_GH_ColourPicker.htm)  

e

    Type: [Grasshopper.GUI.BaseGH_ColourPickerEventArgs](T_Grasshopper_GUI_Base_GH_ColourPickerEventArgs.htm)  
