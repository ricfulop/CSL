---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_Parameters_Param_MeshParameters.htm
scraped_at: 2025-09-08T16:20:06.340065
title: Untitled
---
...
[Param_MeshParameters Constructor
](../html/M_Grasshopper_Kernel_Parameters_Param_MeshParameters__ctor.htm
"Param_MeshParameters Constructor ")

[Param_MeshParameters
Properties](../html/Properties_T_Grasshopper_Kernel_Parameters_Param_MeshParameters.htm
"Param_MeshParameters Properties")

[Param_MeshParameters
Methods](../html/Methods_T_Grasshopper_Kernel_Parameters_Param_MeshParameters.htm
"Param_MeshParameters Methods")

[Param_MeshParameters
Events](../html/Events_T_Grasshopper_Kernel_Parameters_Param_MeshParameters.htm
"Param_MeshParameters Events")

[Param_MeshParameters
Fields](../html/Fields_T_Grasshopper_Kernel_Parameters_Param_MeshParameters.htm
"Param_MeshParameters Fields")
...
[Grasshopper.KernelGH_Param](T_Grasshopper_Kernel_GH_Param_1.htm)[GH_MeshingParameters](T_Grasshopper_Kernel_Types_GH_MeshingParameters.htm)  
[Grasshopper.KernelGH_PersistentParam](T_Grasshopper_Kernel_GH_PersistentParam_1.htm)[GH_MeshingParameters](T_Grasshopper_Kernel_Types_GH_MeshingParameters.htm)  
Grasshopper.Kernel.ParametersParam_MeshParameters  
...
Copy
    ...
    public class Param_MeshParameters : GH_PersistentParam<GH_MeshingParameters>
    
    
    Public Class Param_MeshParameters
    	Inherits GH_PersistentParam(Of GH_MeshingParameters)

The Param_MeshParameters type exposes the following members.
...
[Param_MeshParameters](M_Grasshopper_Kernel_Parameters_Param_MeshParameters__ctor.htm)|
Initializes a new instance of the Param_MeshParameters class  
Top
...
![Public property](../icons/pubproperty.gif)|
[ComponentGuid](P_Grasshopper_Kernel_Parameters_Param_MeshParameters_ComponentGuid.htm)|
(Overrides
...
[GH_InstanceDescription](T_Grasshopper_Kernel_GH_InstanceDescription.htm).)  
![Public property](../icons/pubproperty.gif)|
[Exposure](P_Grasshopper_Kernel_Parameters_Param_MeshParameters_Exposure.htm)|
(Overrides
...
[Icon](P_Grasshopper_Kernel_Parameters_Param_MeshParameters_Icon.htm)|
(Overrides
...
(Inherited from [GH_ParamT](T_Grasshopper_Kernel_GH_Param_1.htm).)  
![Protected method](../icons/protmethod.gif)|
[Menu_AppendPromptMore](M_Grasshopper_Kernel_Parameters_Param_MeshParameters_Menu_AppendPromptMore.htm)|
(Overrides
...
![Protected method](../icons/protmethod.gif)|
[Menu_AppendPromptOne](M_Grasshopper_Kernel_Parameters_Param_MeshParameters_Menu_AppendPromptOne.htm)|
(Overrides
...
[GH_PersistentParamT](T_Grasshopper_Kernel_GH_PersistentParam_1.htm).)  
![Protected method](../icons/protmethod.gif)|
[Prompt_Plural](M_Grasshopper_Kernel_Parameters_Param_MeshParameters_Prompt_Plural.htm)|
(Overrides
[GH_PersistentParamTPrompt_Plural(ListT)](M_Grasshopper_Kernel_GH_PersistentParam_1_Prompt_Plural.htm).)  
![Protected method](../icons/protmethod.gif)|
[Prompt_Singular](M_Grasshopper_Kernel_Parameters_Param_MeshParameters_Prompt_Singular.htm)|
(Overrides
