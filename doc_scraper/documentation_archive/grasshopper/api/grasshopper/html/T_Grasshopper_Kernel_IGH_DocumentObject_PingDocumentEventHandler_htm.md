---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_IGH_DocumentObject_PingDocumentEventHandler.htm
scraped_at: 2025-09-08T16:18:27.846220
title: Untitled
---
...
Copy
    ...
    public delegate void PingDocumentEventHandler(
    	IGH_DocumentObject sender,
    	GH_PingDocumentEventArgs e
    )
    
    
    Public Delegate Sub PingDocumentEventHandler ( 
    	sender As IGH_DocumentObject,
    	e As GH_PingDocumentEventArgs
    )
...
e
    ...
    Type: [Grasshopper.KernelGH_PingDocumentEventArgs](T_Grasshopper_Kernel_GH_PingDocumentEventArgs.htm)  
