---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_IGH_DocumentObject_SolutionExpiredEventHandler.htm
scraped_at: 2025-09-08T16:18:29.841370
title: Untitled
---
...
# IGH_DocumentObjectSolutionExpiredEventHandler Delegate  
...
Copy
    ...
    public delegate void SolutionExpiredEventHandler(
    	IGH_DocumentObject sender,
    	GH_SolutionExpiredEventArgs e
    )
    
    
    Public Delegate Sub SolutionExpiredEventHandler ( 
    	sender As IGH_DocumentObject,
    	e As GH_SolutionExpiredEventArgs
    )
...
e
    ...
    Type: [Grasshopper.KernelGH_SolutionExpiredEventArgs](T_Grasshopper_Kernel_GH_SolutionExpiredEventArgs.htm)  
