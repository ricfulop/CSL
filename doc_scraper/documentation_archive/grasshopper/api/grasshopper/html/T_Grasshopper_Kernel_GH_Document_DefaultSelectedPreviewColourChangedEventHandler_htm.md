---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_GH_Document_DefaultSelectedPreviewColourChangedEventHandler.htm
scraped_at: 2025-09-08T16:16:12.261704
title: Untitled
---
...
# GH_DocumentDefaultSelectedPreviewColourChangedEventHandler Delegate  
...
Copy
    ...
    public delegate void DefaultSelectedPreviewColourChangedEventHandler(
    	Color colour
    )
    
    
    Public Delegate Sub DefaultSelectedPreviewColourChangedEventHandler ( 
    	colour As Color
    )
...
colour
    ...
    Type: [System.DrawingColor](https://docs.microsoft.com/dotnet/api/system.drawing.color)  
