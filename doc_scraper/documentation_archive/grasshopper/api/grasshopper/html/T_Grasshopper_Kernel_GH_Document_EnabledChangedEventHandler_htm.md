---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_GH_Document_EnabledChangedEventHandler.htm
scraped_at: 2025-09-08T16:16:13.263158
title: Untitled
---
...
# GH_DocumentEnabledChangedEventHandler Delegate  
...
Copy
    ...
    public delegate void EnabledChangedEventHandler(
    	Object sender,
    	GH_DocEnabledEventArgs e
    )
    
    
    Public Delegate Sub EnabledChangedEventHandler ( 
    	sender As Object,
    	e As GH_DocEnabledEventArgs
    )
...
e
    ...
    Type: [Grasshopper.KernelGH_DocEnabledEventArgs](T_Grasshopper_Kernel_GH_DocEnabledEventArgs.htm)  
