---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_GUI_Canvas_GH_Canvas_Document_ModifiedChangedEventHandler.htm
scraped_at: 2025-09-08T16:14:13.759071
title: Untitled
---
...
# GH_CanvasDocument_ModifiedChangedEventHandler Delegate  
...
Copy
    ...
    public delegate void Document_ModifiedChangedEventHandler(
    	GH_Document sender,
    	GH_DocModifiedEventArgs e
    )
    
    
    Public Delegate Sub Document_ModifiedChangedEventHandler ( 
    	sender As GH_Document,
    	e As GH_DocModifiedEventArgs
    )
...
e
    ...
    Type: [Grasshopper.KernelGH_DocModifiedEventArgs](T_Grasshopper_Kernel_GH_DocModifiedEventArgs.htm)  
