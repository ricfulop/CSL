---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_GUI_GH_TooltipComponent_PopulateTooltipEventHandler.htm
scraped_at: 2025-09-08T16:13:13.493911
title: Untitled
---
...
Copy
    ...
    public delegate void PopulateTooltipEventHandler(
    	Object sender,
    	GH_TooltipDisplayEventArgs e
    )
    
    
    Public Delegate Sub PopulateTooltipEventHandler ( 
    	sender As Object,
...
e
    ...
    Type: [Grasshopper.GUIGH_TooltipDisplayEventArgs](T_Grasshopper_GUI_GH_TooltipDisplayEventArgs.htm)  
