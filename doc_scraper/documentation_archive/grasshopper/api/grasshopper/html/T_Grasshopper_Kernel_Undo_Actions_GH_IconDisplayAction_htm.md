---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_Undo_Actions_GH_IconDisplayAction.htm
scraped_at: 2025-09-08T16:22:14.801690
title: Untitled
---
...
[GH_IconDisplayAction Constructor
](../html/M_Grasshopper_Kernel_Undo_Actions_GH_IconDisplayAction__ctor.htm
"GH_IconDisplayAction Constructor ")

[GH_IconDisplayAction
Properties](../html/Properties_T_Grasshopper_Kernel_Undo_Actions_GH_IconDisplayAction.htm
"GH_IconDisplayAction Properties")

[GH_IconDisplayAction
Methods](../html/Methods_T_Grasshopper_Kernel_Undo_Actions_GH_IconDisplayAction.htm
"GH_IconDisplayAction Methods")
...
Copy
    ...
    public class GH_IconDisplayAction : GH_ObjectUndoAction
    
    
    Public Class GH_IconDisplayAction
    	Inherits GH_ObjectUndoAction

The GH_IconDisplayAction type exposes the following members.
...
[GH_IconDisplayAction](M_Grasshopper_Kernel_Undo_Actions_GH_IconDisplayAction__ctor.htm)|
Initializes a new instance of the GH_IconDisplayAction class  
Top
...
[GH_ObjectUndoAction](T_Grasshopper_Kernel_Undo_GH_ObjectUndoAction.htm).)  
![Protected method](../icons/protmethod.gif)|
[Object_Redo](M_Grasshopper_Kernel_Undo_Actions_GH_IconDisplayAction_Object_Redo.htm)|
...
![Protected method](../icons/protmethod.gif)|
[Object_Undo](M_Grasshopper_Kernel_Undo_Actions_GH_IconDisplayAction_Object_Undo.htm)|
