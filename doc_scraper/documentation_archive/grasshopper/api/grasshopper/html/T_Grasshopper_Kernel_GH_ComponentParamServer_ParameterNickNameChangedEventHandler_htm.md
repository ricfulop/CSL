---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_GH_ComponentParamServer_ParameterNickNameChangedEventHandler.htm
scraped_at: 2025-09-08T16:15:49.154748
title: Untitled
---
...
# GH_ComponentParamServerParameterNickNameChangedEventHandler Delegate  
...
Copy
    ...
    public delegate void ParameterNickNameChangedEventHandler(
    	Object sender,
    	GH_ParamServerEventArgs e
    )
    
    
    Public Delegate Sub ParameterNickNameChangedEventHandler ( 
    	sender As Object,
    	e As GH_ParamServerEventArgs
    )
...
e
    ...
    Type: [Grasshopper.KernelGH_ParamServerEventArgs](T_Grasshopper_Kernel_GH_ParamServerEventArgs.htm)  
