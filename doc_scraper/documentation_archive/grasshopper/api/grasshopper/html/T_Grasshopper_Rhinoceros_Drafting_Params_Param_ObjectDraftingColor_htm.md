---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingColor.htm
scraped_at: 2025-09-08T16:24:08.302832
title: Untitled
---
...
[Param_ObjectDraftingColor Constructor
](../html/M_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingColor__ctor.htm
"Param_ObjectDraftingColor Constructor ")

[Param_ObjectDraftingColor
Properties](../html/Properties_T_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingColor.htm
"Param_ObjectDraftingColor Properties")

[Param_ObjectDraftingColor
Methods](../html/Methods_T_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingColor.htm
"Param_ObjectDraftingColor Methods")

[Param_ObjectDraftingColor
Events](../html/Events_T_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingColor.htm
"Param_ObjectDraftingColor Events")
...
[Grasshopper.KernelGH_Param](T_Grasshopper_Kernel_GH_Param_1.htm)[ObjectDraftingColor](T_Grasshopper_Rhinoceros_Drafting_ObjectDraftingColor.htm)  
[Grasshopper.KernelGH_PersistentParam](T_Grasshopper_Kernel_GH_PersistentParam_1.htm)[ObjectDraftingColor](T_Grasshopper_Rhinoceros_Drafting_ObjectDraftingColor.htm)  
Grasshopper.Rhinoceros.Drafting.ParamsParam_ObjectDraftingColor  
...
Copy
    ...
    public sealed class Param_ObjectDraftingColor : GH_PersistentParam<ObjectDraftingColor>
    
    
    Public NotInheritable Class Param_ObjectDraftingColor
    	Inherits GH_PersistentParam(Of ObjectDraftingColor)

The Param_ObjectDraftingColor type exposes the following members.
...
[Param_ObjectDraftingColor](M_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingColor__ctor.htm)|
Initializes a new instance of the Param_ObjectDraftingColor class  
Top
...
![Public property](../icons/pubproperty.gif)|
[ComponentGuid](P_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingColor_ComponentGuid.htm)|
(Overrides
...
[GH_InstanceDescription](T_Grasshopper_Kernel_GH_InstanceDescription.htm).)  
![Public property](../icons/pubproperty.gif)|
[Exposure](P_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingColor_Exposure.htm)|
(Overrides
