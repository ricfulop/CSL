---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_Parameters_Param_Predicate.htm
scraped_at: 2025-09-08T16:20:08.309921
title: Untitled
---
...
[Param_Predicate Constructor
](../html/M_Grasshopper_Kernel_Parameters_Param_Predicate__ctor.htm
"Param_Predicate Constructor ")

[Param_Predicate
Properties](../html/Properties_T_Grasshopper_Kernel_Parameters_Param_Predicate.htm
"Param_Predicate Properties")

[Param_Predicate
Methods](../html/Methods_T_Grasshopper_Kernel_Parameters_Param_Predicate.htm
"Param_Predicate Methods")

[Param_Predicate
Events](../html/Events_T_Grasshopper_Kernel_Parameters_Param_Predicate.htm
"Param_Predicate Events")
...
[Grasshopper.KernelGH_Param](T_Grasshopper_Kernel_GH_Param_1.htm)[GH_Predicate](T_Grasshopper_Kernel_Types_GH_Predicate.htm)  
Grasshopper.Kernel.ParametersParam_Predicate  
...
Copy
    ...
    Public NotInheritable Class Param_Predicate
    	Inherits GH_Param(Of GH_Predicate)
...
[Param_Predicate](M_Grasshopper_Kernel_Parameters_Param_Predicate__ctor.htm)|
...
![Public property](../icons/pubproperty.gif)|
[ComponentGuid](P_Grasshopper_Kernel_Parameters_Param_Predicate_ComponentGuid.htm)|
(Overrides
...
[GH_InstanceDescription](T_Grasshopper_Kernel_GH_InstanceDescription.htm).)  
![Public property](../icons/pubproperty.gif)|
[Exposure](P_Grasshopper_Kernel_Parameters_Param_Predicate_Exposure.htm)|
(Overrides
...
[GH_InstanceDescription](T_Grasshopper_Kernel_GH_InstanceDescription.htm).)  
![Public property](../icons/pubproperty.gif)|
[Negate](P_Grasshopper_Kernel_Parameters_Param_Predicate_Negate.htm)|  
![Public property](../icons/pubproperty.gif)|
...
![Public property](../icons/pubproperty.gif)|
[StateTags](P_Grasshopper_Kernel_Parameters_Param_Predicate_StateTags.htm)|
(Overrides
...
(Inherited from [GH_ParamT](T_Grasshopper_Kernel_GH_Param_1.htm).)  
![Public method](../icons/pubmethod.gif)|
[AppendAdditionalMenuItems](M_Grasshopper_Kernel_Parameters_Param_Predicate_AppendAdditionalMenuItems.htm)|
(Overrides
...
[GH_DocumentObject](T_Grasshopper_Kernel_GH_DocumentObject.htm).)  
![Public method](../icons/pubmethod.gif)|
[Read](M_Grasshopper_Kernel_Parameters_Param_Predicate_Read.htm)|  (Overrides
...
[GH_DocumentObject](T_Grasshopper_Kernel_GH_DocumentObject.htm).)  
![Public method](../icons/pubmethod.gif)|
[RemoveEffects](M_Grasshopper_Kernel_Parameters_Param_Predicate_RemoveEffects.htm)|
(Overrides
...
[GH_DocumentObject](T_Grasshopper_Kernel_GH_DocumentObject.htm).)  
![Public method](../icons/pubmethod.gif)|
[Write](M_Grasshopper_Kernel_Parameters_Param_Predicate_Write.htm)|
(Overrides
