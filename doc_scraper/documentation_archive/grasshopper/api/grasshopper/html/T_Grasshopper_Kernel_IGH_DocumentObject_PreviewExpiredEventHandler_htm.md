---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_IGH_DocumentObject_PreviewExpiredEventHandler.htm
scraped_at: 2025-09-08T16:18:28.910187
title: Untitled
---
...
# IGH_DocumentObjectPreviewExpiredEventHandler Delegate  
...
Copy
    ...
    public delegate void PreviewExpiredEventHandler(
    	IGH_DocumentObject sender,
    	GH_PreviewExpiredEventArgs e
    )
    
    
    Public Delegate Sub PreviewExpiredEventHandler ( 
    	sender As IGH_DocumentObject,
    	e As GH_PreviewExpiredEventArgs
    )
...
e
    ...
    Type: [Grasshopper.KernelGH_PreviewExpiredEventArgs](T_Grasshopper_Kernel_GH_PreviewExpiredEventArgs.htm)  
