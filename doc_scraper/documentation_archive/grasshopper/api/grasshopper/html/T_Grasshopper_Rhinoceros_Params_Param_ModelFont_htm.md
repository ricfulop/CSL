---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Rhinoceros_Params_Param_ModelFont.htm
scraped_at: 2025-09-08T16:24:31.447190
title: Untitled
---
...
[Param_ModelFont Constructor
](../html/M_Grasshopper_Rhinoceros_Params_Param_ModelFont__ctor.htm
"Param_ModelFont Constructor ")

[Param_ModelFont
Properties](../html/Properties_T_Grasshopper_Rhinoceros_Params_Param_ModelFont.htm
"Param_ModelFont Properties")

[Param_ModelFont
Methods](../html/Methods_T_Grasshopper_Rhinoceros_Params_Param_ModelFont.htm
"Param_ModelFont Methods")

[Param_ModelFont
Events](../html/Events_T_Grasshopper_Rhinoceros_Params_Param_ModelFont.htm
"Param_ModelFont Events")

[Param_ModelFont
Fields](../html/Fields_T_Grasshopper_Rhinoceros_Params_Param_ModelFont.htm
"Param_ModelFont Fields")
...
[Grasshopper.KernelGH_Param](T_Grasshopper_Kernel_GH_Param_1.htm)[ModelFont](T_Grasshopper_Rhinoceros_ModelFont.htm)  
[Grasshopper.KernelGH_PersistentParam](T_Grasshopper_Kernel_GH_PersistentParam_1.htm)[ModelFont](T_Grasshopper_Rhinoceros_ModelFont.htm)  
Grasshopper.Rhinoceros.ParamsParam_ModelFont  
...
Copy
    ...
    public class Param_ModelFont : GH_PersistentParam<ModelFont>
    
    
    Public Class Param_ModelFont
    	Inherits GH_PersistentParam(Of ModelFont)

The Param_ModelFont type exposes the following members.
...
[Param_ModelFont](M_Grasshopper_Rhinoceros_Params_Param_ModelFont__ctor.htm)|
Initializes a new instance of the Param_ModelFont class  
Top
...
![Public property](../icons/pubproperty.gif)|
[ComponentGuid](P_Grasshopper_Rhinoceros_Params_Param_ModelFont_ComponentGuid.htm)|
(Overrides
...
[GH_InstanceDescription](T_Grasshopper_Kernel_GH_InstanceDescription.htm).)  
![Public property](../icons/pubproperty.gif)|
[Exposure](P_Grasshopper_Rhinoceros_Params_Param_ModelFont_Exposure.htm)|
(Overrides
...
[Icon](P_Grasshopper_Rhinoceros_Params_Param_ModelFont_Icon.htm)|  (Overrides
...
[GH_PersistentParamT](T_Grasshopper_Kernel_GH_PersistentParam_1.htm).)  
![Protected method](../icons/protmethod.gif)|
[Menu_AppendManageCollection](M_Grasshopper_Rhinoceros_Params_Param_ModelFont_Menu_AppendManageCollection.htm)|
(Overrides
...
[GH_PersistentParamT](T_Grasshopper_Kernel_GH_PersistentParam_1.htm).)  
![Protected method](../icons/protmethod.gif)|
[Menu_AppendPromptOne](M_Grasshopper_Rhinoceros_Params_Param_ModelFont_Menu_AppendPromptOne.htm)|
(Overrides
...
[GH_PersistentParamT](T_Grasshopper_Kernel_GH_PersistentParam_1.htm).)  
![Protected method](../icons/protmethod.gif)|
[Menu_CustomMultiValueItem](M_Grasshopper_Rhinoceros_Params_Param_ModelFont_Menu_CustomMultiValueItem.htm)|
(Overrides
...
[GH_ParamT](T_Grasshopper_Kernel_GH_Param_1.htm).)  
![Protected method](../icons/protmethod.gif)|
[PreferredCast](M_Grasshopper_Rhinoceros_Params_Param_ModelFont_PreferredCast.htm)|
(Overrides
...
[GH_PersistentParamT](T_Grasshopper_Kernel_GH_PersistentParam_1.htm).)  
![Protected method](../icons/protmethod.gif)|
[Prompt_Plural](M_Grasshopper_Rhinoceros_Params_Param_ModelFont_Prompt_Plural.htm)|
(Overrides
[GH_PersistentParamTPrompt_Plural(ListT)](M_Grasshopper_Kernel_GH_PersistentParam_1_Prompt_Plural.htm).)  
![Protected method](../icons/protmethod.gif)|
[Prompt_Singular](M_Grasshopper_Rhinoceros_Params_Param_ModelFont_Prompt_Singular.htm)|
(Overrides
