---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_GH_UndoOperation.htm
scraped_at: 2025-09-08T16:18:07.762177
title: Untitled
---
...
Copy
    ...
    Public Enumeration GH_UndoOperation
...
| ClearRedoStack| 1|  The stack with all redo records has been cleared. This
always happens when a new undo record is added.  
| RecordAdded| 2|  A new undo record is added to the list. There will be a
ClearRedoStack event after this one.  
| RecordRemoved| 3|  A specific record has been deleted. This is not a typical
operation and is usually due to user intervention. Removal can occur from both
the undo and the redo stack.  
| Undo| 4|  An undo operation was successfully completed. This means a record
has been moved from the undo stack to the redo stack.  
| Redo| 5|  A redo operation was successfully completed. This means a record
has been moved from the redo stack back onto the undo stack. This does not
count as a RecordAdded operation.  
