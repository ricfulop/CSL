---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Rhinoceros_Model_Params_Param_ModelLayer.htm
scraped_at: 2025-09-08T16:24:23.388845
title: Untitled
---
...
[Param_ModelLayer Constructor
](../html/M_Grasshopper_Rhinoceros_Model_Params_Param_ModelLayer__ctor.htm
"Param_ModelLayer Constructor ")

[Param_ModelLayer
Properties](../html/Properties_T_Grasshopper_Rhinoceros_Model_Params_Param_ModelLayer.htm
"Param_ModelLayer Properties")

[Param_ModelLayer
Methods](../html/Methods_T_Grasshopper_Rhinoceros_Model_Params_Param_ModelLayer.htm
"Param_ModelLayer Methods")

[Param_ModelLayer
Events](../html/Events_T_Grasshopper_Rhinoceros_Model_Params_Param_ModelLayer.htm
"Param_ModelLayer Events")
...
[Grasshopper.KernelGH_Param](T_Grasshopper_Kernel_GH_Param_1.htm)[ModelLayer](T_Grasshopper_Rhinoceros_Model_ModelLayer.htm)  
[Grasshopper.KernelGH_PersistentParam](T_Grasshopper_Kernel_GH_PersistentParam_1.htm)[ModelLayer](T_Grasshopper_Rhinoceros_Model_ModelLayer.htm)  
[Grasshopper.KernelGH_PersistentReferenceParam](T_Grasshopper_Kernel_GH_PersistentReferenceParam_1.htm)[ModelLayer](T_Grasshopper_Rhinoceros_Model_ModelLayer.htm)  
[Grasshopper.Rhinoceros.ParamsModelContentParam](T_Grasshopper_Rhinoceros_Params_ModelContentParam_1.htm)[ModelLayer](T_Grasshopper_Rhinoceros_Model_ModelLayer.htm)  
Grasshopper.Rhinoceros.Model.ParamsParam_ModelLayer  
...
Copy
    ...
    public sealed class Param_ModelLayer : ModelContentParam<ModelLayer>
    
    
    Public NotInheritable Class Param_ModelLayer
    	Inherits ModelContentParam(Of ModelLayer)

The Param_ModelLayer type exposes the following members.
...
[Param_ModelLayer](M_Grasshopper_Rhinoceros_Model_Params_Param_ModelLayer__ctor.htm)|
Initializes a new instance of the Param_ModelLayer class  
Top
...
![Public property](../icons/pubproperty.gif)|
[ComponentGuid](P_Grasshopper_Rhinoceros_Model_Params_Param_ModelLayer_ComponentGuid.htm)|
(Overrides
...
[GH_InstanceDescription](T_Grasshopper_Kernel_GH_InstanceDescription.htm).)  
![Public property](../icons/pubproperty.gif)|
[Exposure](P_Grasshopper_Rhinoceros_Model_Params_Param_ModelLayer_Exposure.htm)|
(Overrides
