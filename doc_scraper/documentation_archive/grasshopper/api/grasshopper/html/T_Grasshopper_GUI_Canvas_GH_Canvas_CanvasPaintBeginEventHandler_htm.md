---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_GUI_Canvas_GH_Canvas_CanvasPaintBeginEventHandler.htm
scraped_at: 2025-09-08T16:14:01.687213
title: Untitled
---
...
# GH_CanvasCanvasPaintBeginEventHandler Delegate  
...
Copy
    ...
    public delegate void CanvasPaintBeginEventHandler(
    	GH_Canvas sender
    )
    
    
    Public Delegate Sub CanvasPaintBeginEventHandler ( 
    	sender As GH_Canvas
    )
