---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_Types_GH_Centermark.htm
scraped_at: 2025-09-08T16:20:23.357002
title: Untitled
---
...
](../html/Overload_Grasshopper_Kernel_Types_GH_Centermark__ctor.htm
"GH_Centermark Constructor ")

[GH_Centermark
Properties](../html/Properties_T_Grasshopper_Kernel_Types_GH_Centermark.htm
"GH_Centermark Properties")

[GH_Centermark
Methods](../html/Methods_T_Grasshopper_Kernel_Types_GH_Centermark.htm
"GH_Centermark Methods")

[GH_Centermark
Fields](../html/Fields_T_Grasshopper_Kernel_Types_GH_Centermark.htm
"GH_Centermark Fields")
...
Grasshopper.Kernel.TypesGH_Centermark  
...
Copy
    ...
    public class GH_Centermark : GH_Dimension
    
    
    Public Class GH_Centermark
    	Inherits GH_Dimension

The GH_Centermark type exposes the following members.
...
[GH_Centermark](M_Grasshopper_Kernel_Types_GH_Centermark__ctor.htm)|  Default
constructor, creates an invalid centermark.  
![Public method](../icons/pubmethod.gif)|
[GH_Centermark(Centermark)](M_Grasshopper_Kernel_Types_GH_Centermark__ctor_2.htm)|
Create a duplicate of an existing centermark.  
![Public method](../icons/pubmethod.gif)|
[GH_Centermark(GH_Centermark)](M_Grasshopper_Kernel_Types_GH_Centermark__ctor_1.htm)|
Create a duplicate of another GH_Centermark. This constructor also copies
reference data.  
![Public method](../icons/pubmethod.gif)|
[GH_Centermark(Guid)](M_Grasshopper_Kernel_Types_GH_Centermark__ctor_4.htm)|
Create a new referenced centermark that references a Rhino centermark with the
specified ID.  
![Public method](../icons/pubmethod.gif)| [GH_Centermark(Centermark,
ModelAnnotationStyle)](M_Grasshopper_Kernel_Types_GH_Centermark__ctor_3.htm)|
Create a duplicate of an existing centermark.  
Top
...
from [GH_AnnotationBase](T_Grasshopper_Kernel_Types_GH_AnnotationBase.htm).)  
![Public property](../icons/pubproperty.gif)|
[TypeDescription](P_Grasshopper_Kernel_Types_GH_Centermark_TypeDescription.htm)|
(Overrides
[GH_AnnotationBaseTypeDescription](P_Grasshopper_Kernel_Types_GH_AnnotationBase_TypeDescription.htm).)  
![Public property](../icons/pubproperty.gif)|
[TypeName](P_Grasshopper_Kernel_Types_GH_Centermark_TypeName.htm)|  (Overrides
[GH_AnnotationBaseTypeName](P_Grasshopper_Kernel_Types_GH_AnnotationBase_TypeName.htm).)  
![Public property](../icons/pubproperty.gif)|
[Value](P_Grasshopper_Kernel_Types_GH_Centermark_Value.htm)|  
![Protected property](../icons/protproperty.gif)|
[ValueType](P_Grasshopper_Kernel_Types_GH_Centermark_ValueType.htm)|
(Overrides
...
[GH_AnnotationBase](T_Grasshopper_Kernel_Types_GH_AnnotationBase.htm).)  
![Public method](../icons/pubmethod.gif)|
[CastFrom](M_Grasshopper_Kernel_Types_GH_Centermark_CastFrom.htm)|  Remote to
...
[GH_AnnotationBase](T_Grasshopper_Kernel_Types_GH_AnnotationBase.htm).)  
![Public method](../icons/pubmethod.gif)|
[CastToT(T)](M_Grasshopper_Kernel_Types_GH_Centermark_CastTo__1.htm)|  Local
...
[GH_AnnotationBase](T_Grasshopper_Kernel_Types_GH_AnnotationBase.htm).)  
![Public method](../icons/pubmethod.gif)|
[DuplicateAnnotation](M_Grasshopper_Kernel_Types_GH_Centermark_DuplicateAnnotation.htm)|
...
![Public method](../icons/pubmethod.gif)|
[DuplicateCentermark](M_Grasshopper_Kernel_Types_GH_Centermark_DuplicateCentermark.htm)|
...
[GH_AnnotationBase](T_Grasshopper_Kernel_Types_GH_AnnotationBase.htm).)  
![Public method](../icons/pubmethod.gif)|
[ToString](M_Grasshopper_Kernel_Types_GH_Centermark_ToString.htm)|  Format the
centermark using default grasshopper formatting logic.  (Overrides
