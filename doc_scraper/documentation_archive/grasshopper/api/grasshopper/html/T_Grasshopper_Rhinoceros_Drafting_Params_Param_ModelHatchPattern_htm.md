---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Rhinoceros_Drafting_Params_Param_ModelHatchPattern.htm
scraped_at: 2025-09-08T16:24:04.301169
title: Untitled
---
...
[Param_ModelHatchPattern Constructor
](../html/M_Grasshopper_Rhinoceros_Drafting_Params_Param_ModelHatchPattern__ctor.htm
"Param_ModelHatchPattern Constructor ")

[Param_ModelHatchPattern
Properties](../html/Properties_T_Grasshopper_Rhinoceros_Drafting_Params_Param_ModelHatchPattern.htm
"Param_ModelHatchPattern Properties")

[Param_ModelHatchPattern
Methods](../html/Methods_T_Grasshopper_Rhinoceros_Drafting_Params_Param_ModelHatchPattern.htm
"Param_ModelHatchPattern Methods")

[Param_ModelHatchPattern
Events](../html/Events_T_Grasshopper_Rhinoceros_Drafting_Params_Param_ModelHatchPattern.htm
"Param_ModelHatchPattern Events")
...
[Grasshopper.KernelGH_Param](T_Grasshopper_Kernel_GH_Param_1.htm)[ModelHatchPattern](T_Grasshopper_Rhinoceros_Drafting_ModelHatchPattern.htm)  
[Grasshopper.KernelGH_PersistentParam](T_Grasshopper_Kernel_GH_PersistentParam_1.htm)[ModelHatchPattern](T_Grasshopper_Rhinoceros_Drafting_ModelHatchPattern.htm)  
[Grasshopper.KernelGH_PersistentReferenceParam](T_Grasshopper_Kernel_GH_PersistentReferenceParam_1.htm)[ModelHatchPattern](T_Grasshopper_Rhinoceros_Drafting_ModelHatchPattern.htm)  
[Grasshopper.Rhinoceros.ParamsModelContentParam](T_Grasshopper_Rhinoceros_Params_ModelContentParam_1.htm)[ModelHatchPattern](T_Grasshopper_Rhinoceros_Drafting_ModelHatchPattern.htm)  
Grasshopper.Rhinoceros.Drafting.ParamsParam_ModelHatchPattern  
...
Copy
    ...
    public sealed class Param_ModelHatchPattern : ModelContentParam<ModelHatchPattern>
    
    
    Public NotInheritable Class Param_ModelHatchPattern
    	Inherits ModelContentParam(Of ModelHatchPattern)

The Param_ModelHatchPattern type exposes the following members.
...
[Param_ModelHatchPattern](M_Grasshopper_Rhinoceros_Drafting_Params_Param_ModelHatchPattern__ctor.htm)|
Initializes a new instance of the Param_ModelHatchPattern class  
Top
...
![Public property](../icons/pubproperty.gif)|
[ComponentGuid](P_Grasshopper_Rhinoceros_Drafting_Params_Param_ModelHatchPattern_ComponentGuid.htm)|
(Overrides
...
[GH_InstanceDescription](T_Grasshopper_Kernel_GH_InstanceDescription.htm).)  
![Public property](../icons/pubproperty.gif)|
[Exposure](P_Grasshopper_Rhinoceros_Drafting_Params_Param_ModelHatchPattern_Exposure.htm)|
(Overrides
