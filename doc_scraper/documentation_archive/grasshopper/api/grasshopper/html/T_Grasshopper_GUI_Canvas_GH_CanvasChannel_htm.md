---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_GUI_Canvas_GH_CanvasChannel.htm
scraped_at: 2025-09-08T16:14:25.807914
title: Untitled
---
...
Enumerates all the drawing channels that are handled inside the Grasshopper
canvas.
...
---|---|---|---  
| First| 0|  First channel. At present, the first channel equals the Groups
channel.  
| Groups| 0|  Channel for Group outlines and name tags.  
| Wires| 10|  Channel for connecting wires.  
| Objects| 20|  Channels for Document Objects (components, parameters, special
objects)  
| Overlay| 30|  Channel for drawing overlay geometry.  
| Last| 30|  Last channel. At present, the last channel equals the Overlay
channel.  
