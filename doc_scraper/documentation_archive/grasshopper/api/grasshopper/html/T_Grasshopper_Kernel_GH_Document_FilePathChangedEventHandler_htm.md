---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_GH_Document_FilePathChangedEventHandler.htm
scraped_at: 2025-09-08T16:16:15.254240
title: Untitled
---
...
Copy
    ...
    public delegate void FilePathChangedEventHandler(
    	Object sender,
    	GH_DocFilePathEventArgs e
    )
    
    
    Public Delegate Sub FilePathChangedEventHandler ( 
    	sender As Object,
    	e As GH_DocFilePathEventArgs
    )
...
e
    ...
    Type: [Grasshopper.KernelGH_DocFilePathEventArgs](T_Grasshopper_Kernel_GH_DocFilePathEventArgs.htm)  
