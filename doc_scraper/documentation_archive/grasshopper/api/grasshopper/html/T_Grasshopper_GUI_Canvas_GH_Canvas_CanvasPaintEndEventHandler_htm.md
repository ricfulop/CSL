---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_GUI_Canvas_GH_Canvas_CanvasPaintEndEventHandler.htm
scraped_at: 2025-09-08T16:14:02.680742
title: Untitled
---
...
# GH_CanvasCanvasPaintEndEventHandler Delegate  
...
Copy
    ...
    public delegate void CanvasPaintEndEventHandler(
    	GH_Canvas sender
    )
    
    
    Public Delegate Sub CanvasPaintEndEventHandler ( 
    	sender As GH_Canvas
    )
