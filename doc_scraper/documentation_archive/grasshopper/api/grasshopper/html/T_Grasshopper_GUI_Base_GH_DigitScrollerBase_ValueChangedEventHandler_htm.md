---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_GUI_Base_GH_DigitScrollerBase_ValueChangedEventHandler.htm
scraped_at: 2025-09-08T16:13:42.583819
title: Untitled
---
...
# GH_DigitScrollerBaseValueChangedEventHandler Delegate  
...
Copy
    ...
    public delegate void ValueChangedEventHandler(
    	Object sender,
    	GH_DigitScrollerEventArgs e
    )
    
    
    Public Delegate Sub ValueChangedEventHandler ( 
    	sender As Object,
    	e As GH_DigitScrollerEventArgs
    )
...
e
    ...
    Type: [Grasshopper.GUI.BaseGH_DigitScrollerEventArgs](T_Grasshopper_GUI_Base_GH_DigitScrollerEventArgs.htm)  
