---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop.htm
scraped_at: 2025-09-08T16:23:37.195208
title: Untitled
---
...
[Param_DisplayColorStop Constructor
](../html/M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop__ctor.htm
"Param_DisplayColorStop Constructor ")

[Param_DisplayColorStop
Properties](../html/Properties_T_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop.htm
"Param_DisplayColorStop Properties")

[Param_DisplayColorStop
Methods](../html/Methods_T_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop.htm
"Param_DisplayColorStop Methods")

[Param_DisplayColorStop
Events](../html/Events_T_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop.htm
"Param_DisplayColorStop Events")

[Param_DisplayColorStop
Fields](../html/Fields_T_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop.htm
"Param_DisplayColorStop Fields")
...
[Grasshopper.KernelGH_Param](T_Grasshopper_Kernel_GH_Param_1.htm)[DisplayColorStop](T_Grasshopper_Rhinoceros_Display_DisplayColorStop.htm)  
[Grasshopper.KernelGH_PersistentParam](T_Grasshopper_Kernel_GH_PersistentParam_1.htm)[DisplayColorStop](T_Grasshopper_Rhinoceros_Display_DisplayColorStop.htm)  
Grasshopper.Rhinoceros.Display.ParamsParam_DisplayColorStop  
...
Copy
    ...
    public class Param_DisplayColorStop : GH_PersistentParam<DisplayColorStop>
    
    
    Public Class Param_DisplayColorStop
    	Inherits GH_PersistentParam(Of DisplayColorStop)

The Param_DisplayColorStop type exposes the following members.
...
[Param_DisplayColorStop](M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop__ctor.htm)|
Initializes a new instance of the Param_DisplayColorStop class  
Top
...
![Public property](../icons/pubproperty.gif)|
[ComponentGuid](P_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop_ComponentGuid.htm)|
(Overrides
...
[GH_InstanceDescription](T_Grasshopper_Kernel_GH_InstanceDescription.htm).)  
![Public property](../icons/pubproperty.gif)|
[Exposure](P_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop_Exposure.htm)|
(Overrides
...
[Icon](P_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop_Icon.htm)|
(Overrides
...
[GH_PersistentParamT](T_Grasshopper_Kernel_GH_PersistentParam_1.htm).)  
![Protected method](../icons/protmethod.gif)|
[Menu_AppendManageCollection](M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop_Menu_AppendManageCollection.htm)|
(Overrides
...
(Inherited from [GH_ParamT](T_Grasshopper_Kernel_GH_Param_1.htm).)  
![Protected method](../icons/protmethod.gif)|
[Menu_AppendPromptMore](M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop_Menu_AppendPromptMore.htm)|
(Overrides
...
![Protected method](../icons/protmethod.gif)|
[Menu_AppendPromptOne](M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop_Menu_AppendPromptOne.htm)|
(Overrides
...
[GH_ParamT](T_Grasshopper_Kernel_GH_Param_1.htm).)  
![Protected method](../icons/protmethod.gif)|
[PreferredCast](M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop_PreferredCast.htm)|
(Overrides
...
[GH_PersistentParamT](T_Grasshopper_Kernel_GH_PersistentParam_1.htm).)  
![Protected method](../icons/protmethod.gif)|
[Prompt_Plural](M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop_Prompt_Plural.htm)|
(Overrides
[GH_PersistentParamTPrompt_Plural(ListT)](M_Grasshopper_Kernel_GH_PersistentParam_1_Prompt_Plural.htm).)  
![Protected method](../icons/protmethod.gif)|
[Prompt_Singular](M_Grasshopper_Rhinoceros_Display_Params_Param_DisplayColorStop_Prompt_Singular.htm)|
(Overrides
