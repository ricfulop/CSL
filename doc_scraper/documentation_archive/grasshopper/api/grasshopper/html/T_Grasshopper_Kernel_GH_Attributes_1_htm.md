---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_GH_Attributes_1.htm
scraped_at: 2025-09-08T16:15:24.022866
title: Untitled
---
...
](../html/M_Grasshopper_Kernel_GH_Attributes_1__ctor.htm "GH_Attributes\(T\)
Constructor ")

[GH_Attributes(T)
Properties](../html/Properties_T_Grasshopper_Kernel_GH_Attributes_1.htm
"GH_Attributes\(T\) Properties")

[GH_Attributes(T)
Methods](../html/Methods_T_Grasshopper_Kernel_GH_Attributes_1.htm
"GH_Attributes\(T\) Methods")

![Click or drag to resize](../icons/TocOpen.gif)![Click or drag to
resize](../icons/TocClose.gif)

# GH_AttributesT Class  
...
Grasshopper.KernelGH_AttributesT  
[Grasshopper.Kernel.AttributesGH_ComponentAttributes](T_Grasshopper_Kernel_Attributes_GH_ComponentAttributes.htm)  
[Grasshopper.Kernel.AttributesGH_FloatingParamAttributes](T_Grasshopper_Kernel_Attributes_GH_FloatingParamAttributes.htm)  
[Grasshopper.Kernel.AttributesGH_LinkedParamAttributes](T_Grasshopper_Kernel_Attributes_GH_LinkedParamAttributes.htm)  
[Grasshopper.Kernel.AttributesGH_ResizableAttributesT](T_Grasshopper_Kernel_Attributes_GH_ResizableAttributes_1.htm)  
[Grasshopper.KernelGH_ComponentParamServerNullParamAttributes](T_Grasshopper_Kernel_GH_ComponentParamServer_NullParamAttributes.htm)  
...
Copy
    ...
    Public MustInherit Class GH_Attributes(Of T As IGH_DocumentObject)
    	Implements IGH_Attributes
...
The GH_AttributesT type exposes the following members.
...
[GH_AttributesT](M_Grasshopper_Kernel_GH_Attributes_1__ctor.htm)|  Construct a
...
balloons to be drawn on top of them.  
![Public property](../icons/pubproperty.gif)|
...
the instance ID of the document object that owns these attributes.  
![Public property](../icons/pubproperty.gif)|
...
_must_ place a call to the base class ExpireLayout().  
![Public method](../icons/pubmethod.gif)|
...
[IsIconMode](M_Grasshopper_Kernel_GH_Attributes_1_IsIconMode.htm)|  Utility
function for determining Icon display modes. If the supplied mode is
::application, then it will be adjusted to match the current app settings.  
![Public method](../icons/pubmethod.gif)|
...
IsMenuRegion calls IsTooltipRegion(PointF).  
![Protected method](../icons/protmethod.gif)|
...
from PerformLayout if the existing layout is stale.  
![Public method](../icons/pubmethod.gif)|
...
![Public method](../icons/pubmethod.gif)|
[Read](M_Grasshopper_Kernel_GH_Attributes_1_Read.htm)|  
![Protected method](../icons/protmethod.gif)|
[Render](M_Grasshopper_Kernel_GH_Attributes_1_Render.htm)|  Override this
function to supply custom Render logic.  
...
into the left side of the attributes.  
![Protected method](../icons/protmethod.gif)| [RenderIncomingWires(GH_Painter,
IEnumerableIGH_Param,
...
the tooltip is ready for display.  
![Public method](../icons/pubmethod.gif)![Static member](../icons/static.gif)|
[SolvePathBoxPick](M_Grasshopper_Kernel_GH_Attributes_1_SolvePathBoxPick.htm)|
Utility function for testing window selections with freeform Graphics paths.  
![Public method](../icons/pubmethod.gif)|
[Write](M_Grasshopper_Kernel_GH_Attributes_1_Write.htm)|  
Top
