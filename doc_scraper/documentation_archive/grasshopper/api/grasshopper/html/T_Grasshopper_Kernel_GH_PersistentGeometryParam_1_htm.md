---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_GH_PersistentGeometryParam_1.htm
scraped_at: 2025-09-08T16:17:26.641069
title: Untitled
---
...
[GH_PersistentGeometryParam(T) Constructor
](../html/Overload_Grasshopper_Kernel_GH_PersistentGeometryParam_1__ctor.htm
"GH_PersistentGeometryParam\(T\) Constructor ")

[GH_PersistentGeometryParam(T)
Properties](../html/Properties_T_Grasshopper_Kernel_GH_PersistentGeometryParam_1.htm
"GH_PersistentGeometryParam\(T\) Properties")

[GH_PersistentGeometryParam(T)
Methods](../html/Methods_T_Grasshopper_Kernel_GH_PersistentGeometryParam_1.htm
"GH_PersistentGeometryParam\(T\) Methods")

[GH_PersistentGeometryParam(T)
Events](../html/Events_T_Grasshopper_Kernel_GH_PersistentGeometryParam_1.htm
"GH_PersistentGeometryParam\(T\) Events")

[GH_PersistentGeometryParam(T)
Fields](../html/Fields_T_Grasshopper_Kernel_GH_PersistentGeometryParam_1.htm
"GH_PersistentGeometryParam\(T\) Fields")

![Click or drag to resize](../icons/TocOpen.gif)![Click or drag to
resize](../icons/TocClose.gif)

# GH_PersistentGeometryParamT Class  
...
Grasshopper.KernelGH_PersistentGeometryParamT  
More...
...
Copy
    ...
    public abstract class GH_PersistentGeometryParam<T> : GH_PersistentParam<T>
    where T : class, IGH_GeometricGoo
    
    
    
    Public MustInherit Class GH_PersistentGeometryParam(Of T As {Class, IGH_GeometricGoo})
    	Inherits GH_PersistentParam(Of T)
...
The GH_PersistentGeometryParamT type exposes the following members.
...
[GH_PersistentGeometryParamT(GH_InstanceDescription)](M_Grasshopper_Kernel_GH_PersistentGeometryParam_1__ctor.htm)|
Initializes a new instance of the GH_PersistentGeometryParamT class  
![Protected method](../icons/protmethod.gif)|
[GH_PersistentGeometryParamT(GH_InstanceDescription,
Boolean)](M_Grasshopper_Kernel_GH_PersistentGeometryParam_1__ctor_1.htm)|
**Obsolete.** Initializes a new instance of the GH_PersistentGeometryParamT
class  
Top
...
(Overrides [GH_ParamTConversionCallback(Object,
T)](M_Grasshopper_Kernel_GH_Param_1_ConversionCallback.htm).)  
![Public method](../icons/pubmethod.gif)|
...
(Overrides
[GH_ActiveObjectExpireSolution(Boolean)](M_Grasshopper_Kernel_GH_ActiveObject_ExpireSolution.htm).)  
![Public method](../icons/pubmethod.gif)|
...
(Overrides
[GH_ParamTOnVolatileDataCollected](M_Grasshopper_Kernel_GH_Param_1_OnVolatileDataCollected.htm).)  
![Protected method](../icons/protmethod.gif)|
...
converted non-referenced data into volatile referenced data.  
![Protected method](../icons/protmethod.gif)|
...
[Grasshopper.KernelGH_PersistentParam](T_Grasshopper_Kernel_GH_PersistentParam_1.htm)T  
Grasshopper.KernelGH_PersistentGeometryParamT  
[Grasshopper.Kernel.ParametersParam_AngularDimension](T_Grasshopper_Kernel_Parameters_Param_AngularDimension.htm)  
[Grasshopper.Kernel.ParametersParam_Centermark](T_Grasshopper_Kernel_Parameters_Param_Centermark.htm)  
[Grasshopper.Kernel.ParametersParam_Hatch](T_Grasshopper_Kernel_Parameters_Param_Hatch.htm)  
[Grasshopper.Kernel.ParametersParam_InstanceReference](T_Grasshopper_Kernel_Parameters_Param_InstanceReference.htm)  
[Grasshopper.Kernel.ParametersParam_Leader](T_Grasshopper_Kernel_Parameters_Param_Leader.htm)  
[Grasshopper.Kernel.ParametersParam_Light](T_Grasshopper_Kernel_Parameters_Param_Light.htm)  
[Grasshopper.Kernel.ParametersParam_LinearDimension](T_Grasshopper_Kernel_Parameters_Param_LinearDimension.htm)  
[Grasshopper.Kernel.ParametersParam_OrdinateDimension](T_Grasshopper_Kernel_Parameters_Param_OrdinateDimension.htm)  
[Grasshopper.Kernel.ParametersParam_RadialDimension](T_Grasshopper_Kernel_Parameters_Param_RadialDimension.htm)  
[Grasshopper.Kernel.ParametersParam_TextDot](T_Grasshopper_Kernel_Parameters_Param_TextDot.htm)  
[Grasshopper.Kernel.ParametersParam_TextEntity](T_Grasshopper_Kernel_Parameters_Param_TextEntity.htm)  
[Grasshopper.Rhinoceros.Display.ParamsParam_ModelView](T_Grasshopper_Rhinoceros_Display_Params_Param_ModelView.htm)  
