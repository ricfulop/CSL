---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_GH_SolutionMode.htm
scraped_at: 2025-09-08T16:17:55.715940
title: Untitled
---
...
Copy
    ...
    Public Enumeration GH_SolutionMode

![](../icons/SectionExpanded.png)Members

| Member name| Value| Description  
---|---|---|---  
| Default| 0|  Represents the standard mode, error messages are displayed in
custom forms.  
| CommandLine| 1|  Represents reduced feedback mode. All messages are send to
the Rhino command history, which is thread safe.  
