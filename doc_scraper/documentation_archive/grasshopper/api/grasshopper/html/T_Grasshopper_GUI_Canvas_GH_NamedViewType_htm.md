---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_GUI_Canvas_GH_NamedViewType.htm
scraped_at: 2025-09-08T16:14:40.856151
title: Untitled
---
...
Copy
    ...
    Public Enumeration GH_NamedViewType

![](../icons/SectionExpanded.png)Members

| Member name| Value| Description  
---|---|---|---  
| target| 0|  Anchor represents the location of the target (the canvas
origin).  
| center| 1|  Anchor represents the point that is supposed to end up in the
