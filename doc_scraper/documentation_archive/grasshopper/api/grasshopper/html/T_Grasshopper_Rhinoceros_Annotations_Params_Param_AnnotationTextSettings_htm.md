---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationTextSettings.htm
scraped_at: 2025-09-08T16:23:10.087577
title: Untitled
---
...
[Param_AnnotationTextSettings Constructor
](../html/M_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationTextSettings__ctor.htm
"Param_AnnotationTextSettings Constructor ")

[Param_AnnotationTextSettings
Properties](../html/Properties_T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationTextSettings.htm
"Param_AnnotationTextSettings Properties")

[Param_AnnotationTextSettings
Methods](../html/Methods_T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationTextSettings.htm
"Param_AnnotationTextSettings Methods")

[Param_AnnotationTextSettings
Events](../html/Events_T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationTextSettings.htm
"Param_AnnotationTextSettings Events")
...
[Grasshopper.KernelGH_Param](T_Grasshopper_Kernel_GH_Param_1.htm)[AnnotationTextSettings](T_Grasshopper_Rhinoceros_Annotations_AnnotationTextSettings.htm)  
[Grasshopper.Rhinoceros.ParamsModelDataParam](T_Grasshopper_Rhinoceros_Params_ModelDataParam_1.htm)[AnnotationTextSettings](T_Grasshopper_Rhinoceros_Annotations_AnnotationTextSettings.htm)  
Grasshopper.Rhinoceros.Annotations.ParamsParam_AnnotationTextSettings  
...
Copy
    ...
    public sealed class Param_AnnotationTextSettings : ModelDataParam<AnnotationTextSettings>
    
    
    Public NotInheritable Class Param_AnnotationTextSettings
    	Inherits ModelDataParam(Of AnnotationTextSettings)

The Param_AnnotationTextSettings type exposes the following members.
...
[Param_AnnotationTextSettings](M_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationTextSettings__ctor.htm)|
Initializes a new instance of the Param_AnnotationTextSettings class  
Top
...
![Public property](../icons/pubproperty.gif)|
[ComponentGuid](P_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationTextSettings_ComponentGuid.htm)|
(Overrides
...
[GH_InstanceDescription](T_Grasshopper_Kernel_GH_InstanceDescription.htm).)  
![Public property](../icons/pubproperty.gif)|
[Exposure](P_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationTextSettings_Exposure.htm)|
(Overrides
