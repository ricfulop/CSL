---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Rhinoceros_Params_Param_ModelContent.htm
scraped_at: 2025-09-08T16:24:30.433581
title: Untitled
---
...
[Param_ModelContent Constructor
](../html/M_Grasshopper_Rhinoceros_Params_Param_ModelContent__ctor.htm
"Param_ModelContent Constructor ")

[Param_ModelContent
Properties](../html/Properties_T_Grasshopper_Rhinoceros_Params_Param_ModelContent.htm
"Param_ModelContent Properties")

[Param_ModelContent
Methods](../html/Methods_T_Grasshopper_Rhinoceros_Params_Param_ModelContent.htm
"Param_ModelContent Methods")

[Param_ModelContent
Events](../html/Events_T_Grasshopper_Rhinoceros_Params_Param_ModelContent.htm
"Param_ModelContent Events")
...
[Grasshopper.KernelGH_Param](T_Grasshopper_Kernel_GH_Param_1.htm)IGH_ModelContentData  
[Grasshopper.KernelGH_PersistentParam](T_Grasshopper_Kernel_GH_PersistentParam_1.htm)IGH_ModelContentData  
[Grasshopper.KernelGH_PersistentReferenceParam](T_Grasshopper_Kernel_GH_PersistentReferenceParam_1.htm)IGH_ModelContentData  
[Grasshopper.Rhinoceros.ParamsModelContentParam](T_Grasshopper_Rhinoceros_Params_ModelContentParam_1.htm)IGH_ModelContentData  
Grasshopper.Rhinoceros.ParamsParam_ModelContent  
...
Copy
    ...
    public sealed class Param_ModelContent : ModelContentParam<IGH_ModelContentData>
    
    
    Public NotInheritable Class Param_ModelContent
    	Inherits ModelContentParam(Of IGH_ModelContentData)

The Param_ModelContent type exposes the following members.
...
[Param_ModelContent](M_Grasshopper_Rhinoceros_Params_Param_ModelContent__ctor.htm)|
Initializes a new instance of the Param_ModelContent class  
Top
...
![Public property](../icons/pubproperty.gif)|
[ComponentGuid](P_Grasshopper_Rhinoceros_Params_Param_ModelContent_ComponentGuid.htm)|
(Overrides
...
[GH_InstanceDescription](T_Grasshopper_Kernel_GH_InstanceDescription.htm).)  
![Public property](../icons/pubproperty.gif)|
[Exposure](P_Grasshopper_Rhinoceros_Params_Param_ModelContent_Exposure.htm)|
(Overrides
...
[GH_ParamT](T_Grasshopper_Kernel_GH_Param_1.htm).)  
![Public property](../icons/pubproperty.gif)|
[TypeName](P_Grasshopper_Rhinoceros_Params_Param_ModelContent_TypeName.htm)|
(Overrides
[GH_PersistentReferenceParamTTypeName](P_Grasshopper_Kernel_GH_PersistentReferenceParam_1_TypeName.htm).)  
![Public property](../icons/pubproperty.gif)|
