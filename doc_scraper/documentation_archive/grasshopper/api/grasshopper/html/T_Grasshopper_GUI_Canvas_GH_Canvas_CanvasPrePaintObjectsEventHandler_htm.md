---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_GUI_Canvas_GH_Canvas_CanvasPrePaintObjectsEventHandler.htm
scraped_at: 2025-09-08T16:14:09.717065
title: Untitled
---
...
# GH_CanvasCanvasPrePaintObjectsEventHandler Delegate  
...
Copy
    ...
    public delegate void CanvasPrePaintObjectsEventHandler(
    	GH_Canvas sender
    )
    
    
    Public Delegate Sub CanvasPrePaintObjectsEventHandler ( 
    	sender As GH_Canvas
    )
