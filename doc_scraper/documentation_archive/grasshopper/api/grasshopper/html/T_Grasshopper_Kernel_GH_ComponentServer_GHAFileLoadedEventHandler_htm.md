---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_GH_ComponentServer_GHAFileLoadedEventHandler.htm
scraped_at: 2025-09-08T16:15:52.176088
title: Untitled
---
...
# GH_ComponentServerGHAFileLoadedEventHandler Delegate  
...
Copy
    ...
    public delegate void GHAFileLoadedEventHandler(
    	Object sender,
    	GH_GHALoadingEventArgs e
    )
    
    
    Public Delegate Sub GHAFileLoadedEventHandler ( 
    	sender As Object,
    	e As GH_GHALoadingEventArgs
    )
...
e
    ...
    Type: [Grasshopper.KernelGH_GHALoadingEventArgs](T_Grasshopper_Kernel_GH_GHALoadingEventArgs.htm)  
