---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Rhinoceros_Params_Param_ModelMeshingParameters.htm
scraped_at: 2025-09-08T16:24:32.418281
title: Untitled
---
...
[Param_ModelMeshingParameters Constructor
](../html/M_Grasshopper_Rhinoceros_Params_Param_ModelMeshingParameters__ctor.htm
"Param_ModelMeshingParameters Constructor ")

[Param_ModelMeshingParameters
Properties](../html/Properties_T_Grasshopper_Rhinoceros_Params_Param_ModelMeshingParameters.htm
"Param_ModelMeshingParameters Properties")

[Param_ModelMeshingParameters
Methods](../html/Methods_T_Grasshopper_Rhinoceros_Params_Param_ModelMeshingParameters.htm
"Param_ModelMeshingParameters Methods")

[Param_ModelMeshingParameters
Events](../html/Events_T_Grasshopper_Rhinoceros_Params_Param_ModelMeshingParameters.htm
"Param_ModelMeshingParameters Events")
...
[Grasshopper.KernelGH_Param](T_Grasshopper_Kernel_GH_Param_1.htm)[ModelMeshingParameters](T_Grasshopper_Rhinoceros_ModelMeshingParameters.htm)  
[Grasshopper.KernelGH_PersistentParam](T_Grasshopper_Kernel_GH_PersistentParam_1.htm)[ModelMeshingParameters](T_Grasshopper_Rhinoceros_ModelMeshingParameters.htm)  
Grasshopper.Rhinoceros.ParamsParam_ModelMeshingParameters  
...
Copy
    ...
    public sealed class Param_ModelMeshingParameters : GH_PersistentParam<ModelMeshingParameters>
    
    
    Public NotInheritable Class Param_ModelMeshingParameters
    	Inherits GH_PersistentParam(Of ModelMeshingParameters)

The Param_ModelMeshingParameters type exposes the following members.
...
[Param_ModelMeshingParameters](M_Grasshopper_Rhinoceros_Params_Param_ModelMeshingParameters__ctor.htm)|
Initializes a new instance of the Param_ModelMeshingParameters class  
Top
...
![Public property](../icons/pubproperty.gif)|
[ComponentGuid](P_Grasshopper_Rhinoceros_Params_Param_ModelMeshingParameters_ComponentGuid.htm)|
(Overrides
...
[GH_InstanceDescription](T_Grasshopper_Kernel_GH_InstanceDescription.htm).)  
![Public property](../icons/pubproperty.gif)|
[Exposure](P_Grasshopper_Rhinoceros_Params_Param_ModelMeshingParameters_Exposure.htm)|
(Overrides
