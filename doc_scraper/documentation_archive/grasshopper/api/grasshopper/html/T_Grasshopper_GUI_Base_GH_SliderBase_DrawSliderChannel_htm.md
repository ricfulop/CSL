---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_GUI_Base_GH_SliderBase_DrawSliderChannel.htm
scraped_at: 2025-09-08T16:13:47.599428
title: Untitled
---
...
Copy
    ...
    Public Delegate Sub DrawSliderChannel ( 
    	slider As GH_SliderBase,
    	G As Graphics
    )
...
slider
    ...
    Type: [Grasshopper.GUI.BaseGH_SliderBase](T_Grasshopper_GUI_Base_GH_SliderBase.htm)  
Slider being drawn.

G

    Type: [System.DrawingGraphics](https://docs.microsoft.com/dotnet/api/system.drawing.graphics)  
