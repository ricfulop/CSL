---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Rhinoceros_Params_ModelDataParam_1.htm
scraped_at: 2025-09-08T16:24:27.434531
title: Untitled
---
...
[ModelDataParam(T) Constructor
](../html/M_Grasshopper_Rhinoceros_Params_ModelDataParam_1__ctor.htm
"ModelDataParam\(T\) Constructor ")

[ModelDataParam(T)
Properties](../html/Properties_T_Grasshopper_Rhinoceros_Params_ModelDataParam_1.htm
"ModelDataParam\(T\) Properties")

[ModelDataParam(T)
Methods](../html/Methods_T_Grasshopper_Rhinoceros_Params_ModelDataParam_1.htm
"ModelDataParam\(T\) Methods")

[ModelDataParam(T)
Events](../html/Events_T_Grasshopper_Rhinoceros_Params_ModelDataParam_1.htm
"ModelDataParam\(T\) Events")

[ModelDataParam(T)
Fields](../html/Fields_T_Grasshopper_Rhinoceros_Params_ModelDataParam_1.htm
"ModelDataParam\(T\) Fields")

![Click or drag to resize](../icons/TocOpen.gif)![Click or drag to
resize](../icons/TocClose.gif)

# ModelDataParamT Class  
...
Grasshopper.Rhinoceros.ParamsModelDataParamT  
More...
...
Copy
    ...
    Public MustInherit Class ModelDataParam(Of T As {Class, IGH_ModelData})
...
The ModelDataParamT type exposes the following members.
...
[ModelDataParamT](M_Grasshopper_Rhinoceros_Params_ModelDataParam_1__ctor.htm)|
Initializes a new instance of the ModelDataParamT class  
Top
...
[Icon](P_Grasshopper_Rhinoceros_Params_ModelDataParam_1_Icon.htm)|  (Overrides
...
[GH_ParamT](T_Grasshopper_Kernel_GH_Param_1.htm).)  
![Public property](../icons/pubproperty.gif)|
[TypeName](P_Grasshopper_Rhinoceros_Params_ModelDataParam_1_TypeName.htm)|
...
Preview 3\. Warnings 4\. Errors  (Inherited from
[GH_ParamT](T_Grasshopper_Kernel_GH_Param_1.htm).)  
![Public method](../icons/pubmethod.gif)|
...
method to provide special data instantiation logic.  (Inherited from
[GH_ParamT](T_Grasshopper_Kernel_GH_Param_1.htm).)  
![Protected method](../icons/protmethod.gif)|
...
[GH_DocumentObject](T_Grasshopper_Kernel_GH_DocumentObject.htm).)  
![Protected method](../icons/protmethod.gif)|
[InstantiateT](M_Grasshopper_Rhinoceros_Params_ModelDataParam_1_InstantiateT.htm)|
(Overrides
...
[GH_ParamT](T_Grasshopper_Kernel_GH_Param_1.htm).)  
![Public method](../icons/pubmethod.gif)|
[Read](M_Grasshopper_Kernel_GH_Param_1_Read.htm)|  (Inherited from
[GH_ParamT](T_Grasshopper_Kernel_GH_Param_1.htm).)  
![Public method](../icons/pubmethod.gif)|
...
(Inherited from [GH_ParamT](T_Grasshopper_Kernel_GH_Param_1.htm).)  
![Public method](../icons/pubmethod.gif)|
[Write](M_Grasshopper_Kernel_GH_Param_1_Write.htm)|  (Inherited from
[GH_ParamT](T_Grasshopper_Kernel_GH_Param_1.htm).)  
![Public method](../icons/pubmethod.gif)|
...
[Grasshopper.KernelGH_Param](T_Grasshopper_Kernel_GH_Param_1.htm)T  
Grasshopper.Rhinoceros.ParamsModelDataParamT  
[Grasshopper.Rhinoceros.Annotations.ParamsParam_AnnotationArrowSettings](T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationArrowSettings.htm)  
[Grasshopper.Rhinoceros.Annotations.ParamsParam_AnnotationDimensionSettings](T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationDimensionSettings.htm)  
[Grasshopper.Rhinoceros.Annotations.ParamsParam_AnnotationLeaderSettings](T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationLeaderSettings.htm)  
[Grasshopper.Rhinoceros.Annotations.ParamsParam_AnnotationTextSettings](T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationTextSettings.htm)  
[Grasshopper.Rhinoceros.Annotations.ParamsParam_AnnotationToleranceSettings](T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationToleranceSettings.htm)  
[Grasshopper.Rhinoceros.Annotations.ParamsParam_AnnotationUnitsSettings](T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationUnitsSettings.htm)  
[Grasshopper.Rhinoceros.Display.ParamsParam_ObjectDisplay](T_Grasshopper_Rhinoceros_Display_Params_Param_ObjectDisplay.htm)  
[Grasshopper.Rhinoceros.Display.ParamsParam_ObjectVisibility](T_Grasshopper_Rhinoceros_Display_Params_Param_ObjectVisibility.htm)  
[Grasshopper.Rhinoceros.Drafting.ParamsParam_ObjectDrafting](T_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDrafting.htm)  
[Grasshopper.Rhinoceros.Render.ParamsParam_ObjectRender](T_Grasshopper_Rhinoceros_Render_Params_Param_ObjectRender.htm)  
