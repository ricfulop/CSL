---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_Parameters_Param_LinearDimension.htm
scraped_at: 2025-09-08T16:20:05.330042
title: Untitled
---
...
[Param_LinearDimension Constructor
](../html/M_Grasshopper_Kernel_Parameters_Param_LinearDimension__ctor.htm
"Param_LinearDimension Constructor ")

[Param_LinearDimension
Properties](../html/Properties_T_Grasshopper_Kernel_Parameters_Param_LinearDimension.htm
"Param_LinearDimension Properties")

[Param_LinearDimension
Methods](../html/Methods_T_Grasshopper_Kernel_Parameters_Param_LinearDimension.htm
"Param_LinearDimension Methods")

[Param_LinearDimension
Events](../html/Events_T_Grasshopper_Kernel_Parameters_Param_LinearDimension.htm
"Param_LinearDimension Events")

[Param_LinearDimension
Fields](../html/Fields_T_Grasshopper_Kernel_Parameters_Param_LinearDimension.htm
"Param_LinearDimension Fields")
...
[Grasshopper.KernelGH_Param](T_Grasshopper_Kernel_GH_Param_1.htm)[GH_LinearDimension](T_Grasshopper_Kernel_Types_GH_LinearDimension.htm)  
[Grasshopper.KernelGH_PersistentParam](T_Grasshopper_Kernel_GH_PersistentParam_1.htm)[GH_LinearDimension](T_Grasshopper_Kernel_Types_GH_LinearDimension.htm)  
[Grasshopper.KernelGH_PersistentGeometryParam](T_Grasshopper_Kernel_GH_PersistentGeometryParam_1.htm)[GH_LinearDimension](T_Grasshopper_Kernel_Types_GH_LinearDimension.htm)  
Grasshopper.Kernel.ParametersParam_LinearDimension  
...
Copy
    ...
    public class Param_LinearDimension : GH_PersistentGeometryParam<GH_LinearDimension>, 
    	IGH_PreviewObject, IGH_BakeAwareObject
    
    
    Public Class Param_LinearDimension
    	Inherits GH_PersistentGeometryParam(Of GH_LinearDimension)
    	Implements IGH_PreviewObject, IGH_BakeAwareObject

The Param_LinearDimension type exposes the following members.
...
[Param_LinearDimension](M_Grasshopper_Kernel_Parameters_Param_LinearDimension__ctor.htm)|
Initializes a new instance of the Param_LinearDimension class  
Top
...
![Public property](../icons/pubproperty.gif)|
[ClippingBox](P_Grasshopper_Kernel_Parameters_Param_LinearDimension_ClippingBox.htm)|  
![Public property](../icons/pubproperty.gif)|
[ComponentGuid](P_Grasshopper_Kernel_Parameters_Param_LinearDimension_ComponentGuid.htm)|
(Overrides
...
[GH_InstanceDescription](T_Grasshopper_Kernel_GH_InstanceDescription.htm).)  
![Public property](../icons/pubproperty.gif)|
[Exposure](P_Grasshopper_Kernel_Parameters_Param_LinearDimension_Exposure.htm)|
(Overrides
...
[GH_InstanceDescription](T_Grasshopper_Kernel_GH_InstanceDescription.htm).)  
![Public property](../icons/pubproperty.gif)|
[Hidden](P_Grasshopper_Kernel_Parameters_Param_LinearDimension_Hidden.htm)|  
![Protected property](../icons/protproperty.gif)|
[Icon](P_Grasshopper_Kernel_Parameters_Param_LinearDimension_Icon.htm)|
(Overrides
...
[GH_InstanceDescription](T_Grasshopper_Kernel_GH_InstanceDescription.htm).)  
![Public property](../icons/pubproperty.gif)|
[IsBakeCapable](P_Grasshopper_Kernel_Parameters_Param_LinearDimension_IsBakeCapable.htm)|  
![Public property](../icons/pubproperty.gif)|
...
![Public property](../icons/pubproperty.gif)|
[IsPreviewCapable](P_Grasshopper_Kernel_Parameters_Param_LinearDimension_IsPreviewCapable.htm)|  
![Public property](../icons/pubproperty.gif)|
...
ListGuid)](M_Grasshopper_Kernel_Parameters_Param_LinearDimension_BakeGeometry_1.htm)|  
![Public method](../icons/pubmethod.gif)| [BakeGeometry(RhinoDoc,
ObjectAttributes,
ListGuid)](M_Grasshopper_Kernel_Parameters_Param_LinearDimension_BakeGeometry.htm)|  
...
[GH_DocumentObject](T_Grasshopper_Kernel_GH_DocumentObject.htm).)  
![Public method](../icons/pubmethod.gif)|
[DrawViewportMeshes](M_Grasshopper_Kernel_Parameters_Param_LinearDimension_DrawViewportMeshes.htm)|  
![Public method](../icons/pubmethod.gif)|
[DrawViewportWires](M_Grasshopper_Kernel_Parameters_Param_LinearDimension_DrawViewportWires.htm)|  
![Protected method](../icons/protmethod.gif)|
...
[GH_DocumentObject](T_Grasshopper_Kernel_GH_DocumentObject.htm).)  
![Protected method](../icons/protmethod.gif)|
[HtmlHelp_Source](M_Grasshopper_Kernel_Parameters_Param_LinearDimension_HtmlHelp_Source.htm)|
(Overrides
[GH_DocumentObjectHtmlHelp_Source](M_Grasshopper_Kernel_GH_DocumentObject_HtmlHelp_Source.htm).)  
![Protected method](../icons/protmethod.gif)|
[InstantiateT](M_Grasshopper_Kernel_Parameters_Param_LinearDimension_InstantiateT.htm)|
(Overrides
...
[GH_PersistentParamT](T_Grasshopper_Kernel_GH_PersistentParam_1.htm).)  
![Protected method](../icons/protmethod.gif)|
[Menu_AppendManageCollection](M_Grasshopper_Kernel_Parameters_Param_LinearDimension_Menu_AppendManageCollection.htm)|
(Overrides
...
[GH_PersistentGeometryParamT](T_Grasshopper_Kernel_GH_PersistentGeometryParam_1.htm).)  
![Protected method](../icons/protmethod.gif)|
[PreferredCast](M_Grasshopper_Kernel_Parameters_Param_LinearDimension_PreferredCast.htm)|
(Overrides
...
[GH_PersistentParamT](T_Grasshopper_Kernel_GH_PersistentParam_1.htm).)  
![Protected method](../icons/protmethod.gif)|
[Prompt_Plural](M_Grasshopper_Kernel_Parameters_Param_LinearDimension_Prompt_Plural.htm)|
(Overrides
[GH_PersistentParamTPrompt_Plural(ListT)](M_Grasshopper_Kernel_GH_PersistentParam_1_Prompt_Plural.htm).)  
![Protected method](../icons/protmethod.gif)|
[Prompt_Singular](M_Grasshopper_Kernel_Parameters_Param_LinearDimension_Prompt_Singular.htm)|
(Overrides
[GH_PersistentParamTPrompt_Singular(T)](M_Grasshopper_Kernel_GH_PersistentParam_1_Prompt_Singular.htm).)  
![Public method](../icons/pubmethod.gif)|
[Read](M_Grasshopper_Kernel_Parameters_Param_LinearDimension_Read.htm)|
(Overrides
