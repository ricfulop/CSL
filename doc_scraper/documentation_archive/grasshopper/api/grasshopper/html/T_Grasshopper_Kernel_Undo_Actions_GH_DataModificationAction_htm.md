---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_Undo_Actions_GH_DataModificationAction.htm
scraped_at: 2025-09-08T16:22:11.780612
title: Untitled
---
...
[GH_DataModificationAction Constructor
](../html/M_Grasshopper_Kernel_Undo_Actions_GH_DataModificationAction__ctor.htm
"GH_DataModificationAction Constructor ")

[GH_DataModificationAction
Properties](../html/Properties_T_Grasshopper_Kernel_Undo_Actions_GH_DataModificationAction.htm
"GH_DataModificationAction Properties")

[GH_DataModificationAction
Methods](../html/Methods_T_Grasshopper_Kernel_Undo_Actions_GH_DataModificationAction.htm
"GH_DataModificationAction Methods")
...
Copy
    ...
    public class GH_DataModificationAction : GH_ObjectUndoAction
    
    
    Public Class GH_DataModificationAction
    	Inherits GH_ObjectUndoAction

The GH_DataModificationAction type exposes the following members.
...
[GH_DataModificationAction](M_Grasshopper_Kernel_Undo_Actions_GH_DataModificationAction__ctor.htm)|
Initializes a new instance of the GH_DataModificationAction class  
Top
...
![Public property](../icons/pubproperty.gif)|
[ExpiresSolution](P_Grasshopper_Kernel_Undo_Actions_GH_DataModificationAction_ExpiresSolution.htm)|
(Overrides
...
[GH_ObjectUndoAction](T_Grasshopper_Kernel_Undo_GH_ObjectUndoAction.htm).)  
![Protected method](../icons/protmethod.gif)|
[Object_Redo](M_Grasshopper_Kernel_Undo_Actions_GH_DataModificationAction_Object_Redo.htm)|
...
![Protected method](../icons/protmethod.gif)|
[Object_Undo](M_Grasshopper_Kernel_Undo_Actions_GH_DataModificationAction_Object_Undo.htm)|
