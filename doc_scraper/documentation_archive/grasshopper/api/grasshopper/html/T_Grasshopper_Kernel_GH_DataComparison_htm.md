---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_GH_DataComparison.htm
scraped_at: 2025-09-08T16:15:59.198125
title: Untitled
---
...
---|---|---|---  
| ShortestList| 0|  Matches data in all lists until the shortest list runs
dry. This flag will omit data entries if lists have a different length  
| LongestList| 1|  Matches data in all lists until the longest list runs dry.
This is the default behaviour  
| CrossReference| 2|  Matches data in all lists in all possible combinations.
