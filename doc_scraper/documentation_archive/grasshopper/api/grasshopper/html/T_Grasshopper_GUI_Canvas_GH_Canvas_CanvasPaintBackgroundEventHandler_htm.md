---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_GUI_Canvas_GH_Canvas_CanvasPaintBackgroundEventHandler.htm
scraped_at: 2025-09-08T16:14:00.686280
title: Untitled
---
...
# GH_CanvasCanvasPaintBackgroundEventHandler Delegate  
...
Copy
    ...
    public delegate void CanvasPaintBackgroundEventHandler(
    	GH_Canvas sender
    )
    
    
    Public Delegate Sub CanvasPaintBackgroundEventHandler ( 
    	sender As GH_Canvas
    )
