---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_GH_Document_GH_ActiveObjectFilter.htm
scraped_at: 2025-09-08T16:16:16.274165
title: Untitled
---
...
# GH_DocumentGH_ActiveObjectFilter Delegate  
...
Copy
    ...
    public delegate bool GH_ActiveObjectFilter(
    	IGH_ActiveObject iObj
    )
    
    
    Public Delegate Function GH_ActiveObjectFilter ( 
    	iObj As IGH_ActiveObject
    ) As Boolean
...
iObj
    ...
    Type: [Grasshopper.KernelIGH_ActiveObject](T_Grasshopper_Kernel_IGH_ActiveObject.htm)  
