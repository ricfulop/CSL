---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_GUI_Canvas_GH_Canvas_WidgetListCreatedEventHandler.htm
scraped_at: 2025-09-08T16:14:24.781700
title: Untitled
---
...
Copy
    ...
    public delegate void WidgetListCreatedEventHandler(
    	Object sender,
    	GH_CanvasWidgetListEventArgs e
    )
    
    
    Public Delegate Sub WidgetListCreatedEventHandler ( 
    	sender As Object,
    	e As GH_CanvasWidgetListEventArgs
    )
...
e
    ...
    Type: [Grasshopper.GUI.CanvasGH_CanvasWidgetListEventArgs](T_Grasshopper_GUI_Canvas_GH_CanvasWidgetListEventArgs.htm)  
