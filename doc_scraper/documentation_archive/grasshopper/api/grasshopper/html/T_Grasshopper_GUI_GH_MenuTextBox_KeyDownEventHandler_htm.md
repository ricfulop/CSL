---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_GUI_GH_MenuTextBox_KeyDownEventHandler.htm
scraped_at: 2025-09-08T16:12:54.400000
title: Untitled
---
...
# GH_MenuTextBoxKeyDownEventHandler Delegate  
...
Copy
    ...
    Public Delegate Sub KeyDownEventHandler ( 
    	sender As GH_MenuTextBox,
    	e As KeyEventArgs
    )
...
sender
    ...
    Type: [Grasshopper.GUIGH_MenuTextBox](T_Grasshopper_GUI_GH_MenuTextBox.htm)  

e

    Type: [System.Windows.FormsKeyEventArgs](https://docs.microsoft.com/dotnet/api/system.windows.forms.keyeventargs)  
