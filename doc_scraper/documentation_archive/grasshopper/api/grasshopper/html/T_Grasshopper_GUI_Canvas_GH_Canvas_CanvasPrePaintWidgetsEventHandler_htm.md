---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_GUI_Canvas_GH_Canvas_CanvasPrePaintWidgetsEventHandler.htm
scraped_at: 2025-09-08T16:14:11.740875
title: Untitled
---
...
# GH_CanvasCanvasPrePaintWidgetsEventHandler Delegate  
...
Copy
    ...
    public delegate void CanvasPrePaintWidgetsEventHandler(
    	GH_Canvas sender
    )
    
    
    Public Delegate Sub CanvasPrePaintWidgetsEventHandler ( 
    	sender As GH_Canvas
    )
