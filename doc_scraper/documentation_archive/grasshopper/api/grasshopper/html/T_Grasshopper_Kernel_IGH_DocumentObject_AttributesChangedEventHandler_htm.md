---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Kernel_IGH_DocumentObject_AttributesChangedEventHandler.htm
scraped_at: 2025-09-08T16:18:24.834117
title: Untitled
---
...
# IGH_DocumentObjectAttributesChangedEventHandler Delegate  
...
Copy
    ...
    public delegate void AttributesChangedEventHandler(
    	...
    	GH_AttributesChangedEventArgs e
    )
    
    
    Public Delegate Sub AttributesChangedEventHandler ( 
    	sender As IGH_DocumentObject,
    	e As GH_AttributesChangedEventArgs
    )
...
e
    ...
    Type: [Grasshopper.KernelGH_AttributesChangedEventArgs](T_Grasshopper_Kernel_GH_AttributesChangedEventArgs.htm)  
