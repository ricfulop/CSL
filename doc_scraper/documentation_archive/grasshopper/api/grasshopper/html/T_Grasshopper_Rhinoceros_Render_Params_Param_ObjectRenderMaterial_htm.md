---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Rhinoceros_Render_Params_Param_ObjectRenderMaterial.htm
scraped_at: 2025-09-08T16:24:56.519843
title: Untitled
---
...
[Param_ObjectRenderMaterial Constructor
](../html/M_Grasshopper_Rhinoceros_Render_Params_Param_ObjectRenderMaterial__ctor.htm
"Param_ObjectRenderMaterial Constructor ")

[Param_ObjectRenderMaterial
Properties](../html/Properties_T_Grasshopper_Rhinoceros_Render_Params_Param_ObjectRenderMaterial.htm
"Param_ObjectRenderMaterial Properties")

[Param_ObjectRenderMaterial
Methods](../html/Methods_T_Grasshopper_Rhinoceros_Render_Params_Param_ObjectRenderMaterial.htm
"Param_ObjectRenderMaterial Methods")

[Param_ObjectRenderMaterial
Events](../html/Events_T_Grasshopper_Rhinoceros_Render_Params_Param_ObjectRenderMaterial.htm
"Param_ObjectRenderMaterial Events")
...
[Grasshopper.KernelGH_Param](T_Grasshopper_Kernel_GH_Param_1.htm)[ObjectRenderMaterial](T_Grasshopper_Rhinoceros_Render_ObjectRenderMaterial.htm)  
[Grasshopper.KernelGH_PersistentParam](T_Grasshopper_Kernel_GH_PersistentParam_1.htm)[ObjectRenderMaterial](T_Grasshopper_Rhinoceros_Render_ObjectRenderMaterial.htm)  
Grasshopper.Rhinoceros.Render.ParamsParam_ObjectRenderMaterial  
...
Copy
    ...
    public sealed class Param_ObjectRenderMaterial : GH_PersistentParam<ObjectRenderMaterial>
    
    
    Public NotInheritable Class Param_ObjectRenderMaterial
    	Inherits GH_PersistentParam(Of ObjectRenderMaterial)

The Param_ObjectRenderMaterial type exposes the following members.
...
[Param_ObjectRenderMaterial](M_Grasshopper_Rhinoceros_Render_Params_Param_ObjectRenderMaterial__ctor.htm)|
Initializes a new instance of the Param_ObjectRenderMaterial class  
Top
...
![Public property](../icons/pubproperty.gif)|
[ComponentGuid](P_Grasshopper_Rhinoceros_Render_Params_Param_ObjectRenderMaterial_ComponentGuid.htm)|
(Overrides
...
[GH_InstanceDescription](T_Grasshopper_Kernel_GH_InstanceDescription.htm).)  
![Public property](../icons/pubproperty.gif)|
[Exposure](P_Grasshopper_Rhinoceros_Render_Params_Param_ObjectRenderMaterial_Exposure.htm)|
(Overrides
...
[GH_ActiveObject](T_Grasshopper_Kernel_GH_ActiveObject.htm).)  
![Public method](../icons/pubmethod.gif)|
[ClearData](M_Grasshopper_Rhinoceros_Render_Params_Param_ObjectRenderMaterial_ClearData.htm)|
(Overrides
...
[GH_DocumentObject](T_Grasshopper_Kernel_GH_DocumentObject.htm).)  
![Public method](../icons/pubmethod.gif)|
[RegisterRemoteIDs](M_Grasshopper_Rhinoceros_Render_Params_Param_ObjectRenderMaterial_RegisterRemoteIDs.htm)|
(Overrides
