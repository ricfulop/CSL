---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_GUI_Canvas_GH_Canvas_CanvasPrePaintOverlayEventHandler.htm
scraped_at: 2025-09-08T16:14:10.743789
title: Untitled
---
...
# GH_CanvasCanvasPrePaintOverlayEventHandler Delegate  
...
Copy
    ...
    public delegate void CanvasPrePaintOverlayEventHandler(
    	GH_Canvas sender
    )
    
    
    Public Delegate Sub CanvasPrePaintOverlayEventHandler ( 
    	sender As GH_Canvas
    )
