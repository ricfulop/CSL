---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingLineWidth.htm
scraped_at: 2025-09-08T16:24:10.347939
title: Untitled
---
...
[Param_ObjectDraftingLineWidth Constructor
](../html/M_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingLineWidth__ctor.htm
"Param_ObjectDraftingLineWidth Constructor ")

[Param_ObjectDraftingLineWidth
Properties](../html/Properties_T_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingLineWidth.htm
"Param_ObjectDraftingLineWidth Properties")

[Param_ObjectDraftingLineWidth
Methods](../html/Methods_T_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingLineWidth.htm
"Param_ObjectDraftingLineWidth Methods")

[Param_ObjectDraftingLineWidth
Events](../html/Events_T_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingLineWidth.htm
"Param_ObjectDraftingLineWidth Events")
...
[Grasshopper.KernelGH_Param](T_Grasshopper_Kernel_GH_Param_1.htm)[ObjectDraftingLineWidth](T_Grasshopper_Rhinoceros_Drafting_ObjectDraftingLineWidth.htm)  
[Grasshopper.KernelGH_PersistentParam](T_Grasshopper_Kernel_GH_PersistentParam_1.htm)[ObjectDraftingLineWidth](T_Grasshopper_Rhinoceros_Drafting_ObjectDraftingLineWidth.htm)  
Grasshopper.Rhinoceros.Drafting.ParamsParam_ObjectDraftingLineWidth  
...
Copy
    ...
    public sealed class Param_ObjectDraftingLineWidth : GH_PersistentParam<ObjectDraftingLineWidth>
    
    
    Public NotInheritable Class Param_ObjectDraftingLineWidth
    	Inherits GH_PersistentParam(Of ObjectDraftingLineWidth)

The Param_ObjectDraftingLineWidth type exposes the following members.
...
[Param_ObjectDraftingLineWidth](M_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingLineWidth__ctor.htm)|
Initializes a new instance of the Param_ObjectDraftingLineWidth class  
Top
...
![Public property](../icons/pubproperty.gif)|
[ComponentGuid](P_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingLineWidth_ComponentGuid.htm)|
(Overrides
...
[GH_InstanceDescription](T_Grasshopper_Kernel_GH_InstanceDescription.htm).)  
![Public property](../icons/pubproperty.gif)|
[Exposure](P_Grasshopper_Rhinoceros_Drafting_Params_Param_ObjectDraftingLineWidth_Exposure.htm)|
(Overrides
