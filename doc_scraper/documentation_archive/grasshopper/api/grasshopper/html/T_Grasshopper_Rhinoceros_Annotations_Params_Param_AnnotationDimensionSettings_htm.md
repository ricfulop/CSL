---
url: https://developer.rhino3d.com/api/grasshopper/html/T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationDimensionSettings.htm
scraped_at: 2025-09-08T16:23:08.101704
title: Untitled
---
...
[Param_AnnotationDimensionSettings Constructor
](../html/M_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationDimensionSettings__ctor.htm
"Param_AnnotationDimensionSettings Constructor ")

[Param_AnnotationDimensionSettings
Properties](../html/Properties_T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationDimensionSettings.htm
"Param_AnnotationDimensionSettings Properties")

[Param_AnnotationDimensionSettings
Methods](../html/Methods_T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationDimensionSettings.htm
"Param_AnnotationDimensionSettings Methods")

[Param_AnnotationDimensionSettings
Events](../html/Events_T_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationDimensionSettings.htm
"Param_AnnotationDimensionSettings Events")
...
[Grasshopper.KernelGH_Param](T_Grasshopper_Kernel_GH_Param_1.htm)[AnnotationDimensionSettings](T_Grasshopper_Rhinoceros_Annotations_AnnotationDimensionSettings.htm)  
[Grasshopper.Rhinoceros.ParamsModelDataParam](T_Grasshopper_Rhinoceros_Params_ModelDataParam_1.htm)[AnnotationDimensionSettings](T_Grasshopper_Rhinoceros_Annotations_AnnotationDimensionSettings.htm)  
Grasshopper.Rhinoceros.Annotations.ParamsParam_AnnotationDimensionSettings  

**Namespace:**
[Grasshopper.Rhinoceros.Annotations.Params](N_Grasshopper_Rhinoceros_Annotations_Params.htm)  
...
Copy
    ...
    public sealed class Param_AnnotationDimensionSettings : ModelDataParam<AnnotationDimensionSettings>
    
    
    Public NotInheritable Class Param_AnnotationDimensionSettings
    	Inherits ModelDataParam(Of AnnotationDimensionSettings)

The Param_AnnotationDimensionSettings type exposes the following members.
...
[Param_AnnotationDimensionSettings](M_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationDimensionSettings__ctor.htm)|
Initializes a new instance of the Param_AnnotationDimensionSettings class  
Top
...
![Public property](../icons/pubproperty.gif)|
[ComponentGuid](P_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationDimensionSettings_ComponentGuid.htm)|
(Overrides
...
[GH_InstanceDescription](T_Grasshopper_Kernel_GH_InstanceDescription.htm).)  
![Public property](../icons/pubproperty.gif)|
[Exposure](P_Grasshopper_Rhinoceros_Annotations_Params_Param_AnnotationDimensionSettings_Exposure.htm)|
(Overrides
...
[Grasshopper.Rhinoceros.Annotations.Params
Namespace](N_Grasshopper_Rhinoceros_Annotations_Params.htm)
