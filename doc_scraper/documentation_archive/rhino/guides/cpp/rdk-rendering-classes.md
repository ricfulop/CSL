...
In addition to the built-in functionality, plug-in developers have the ability
...
The user can also choose to clone the render frame. What this means under the
